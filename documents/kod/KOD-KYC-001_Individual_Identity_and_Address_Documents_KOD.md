...
title: "Individual Identity and Address Documents KOD"
...
keywords:
  ...
  - "verification"
  - "individual identity and address documents kod"
  - "KOD-KYC-001"
  - "Individual"
  - "Identity"
  - "Address"
...
This Knowledge of Documents record defines the acceptable document evidence, validation rules, acceptance criteria, rejection criteria, and common errors for KYC activity under KOD-KYC-001. It is used by Operations Officer, Operations Manager, Compliance Officer, Senior Compliance Officer, AML Analyst, and Credit Risk Officer roles where the related policy and SOP require documentary evidence.
...
| --- | --- | --- |
| [POL-KYC-001](../policies/POL-KYC-001_Customer_Identification_and_Verification_Policy.md) | Customer Identification and Verification Policy | KOD evidence reference |
| [SOP-KYC-001](../sops/SOP-KYC-001_Customer_Identity_Verification_SOP.md) | Customer Identity Verification SOP | KOD evidence reference |
| [EXM-KYC-001](../exception_matrices/EXM-KYC-001_Identity_Document_Exception_Matrix.md) | Identity Document Exception Matrix | KOD evidence reference |

## 9 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for KOD-KYC-001 Individual Identity and Address Documents KOD. | Chief Compliance Officer |
