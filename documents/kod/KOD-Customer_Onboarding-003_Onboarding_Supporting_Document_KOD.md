...
title: "Onboarding Supporting Document KOD"
...
keywords:
  ...
  - "data quality"
  - "approval routing"
  - "onboarding supporting document kod"
  - "KOD-Customer"
  - "Onboarding-003"
  - "Onboarding"
  - "Supporting"
...
This Knowledge of Documents record defines the acceptable document evidence, validation rules, acceptance criteria, rejection criteria, and common errors for Customer Onboarding activity under KOD-Customer Onboarding-003. It is used by Operations Officer, Operations Manager, Compliance Officer, Senior Compliance Officer, AML Analyst, and Credit Risk Officer roles where the related policy and SOP require documentary evidence.
...
| --- | --- | --- |
| [POL-Customer Onboarding-003](../policies/POL-Customer_Onboarding-003_Customer_Onboarding_Approval_Policy.md) | Customer Onboarding Approval Policy | KOD evidence reference |
| [SOP-Customer Onboarding-003](../sops/SOP-Customer_Onboarding-003_Onboarding_Approval_Routing_SOP.md) | Onboarding Approval Routing SOP | KOD evidence reference |
| [EXM-Customer Onboarding-003](../exception_matrices/EXM-Customer_Onboarding-003_Onboarding_Data_Exception_Matrix.md) | Onboarding Data Exception Matrix | KOD evidence reference |

## 9 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for KOD-Customer Onboarding-003 Onboarding Supporting Document KOD. | Chief Compliance Officer |
