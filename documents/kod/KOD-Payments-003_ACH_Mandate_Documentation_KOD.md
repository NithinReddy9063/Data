...
title: "ACH Mandate Documentation KOD"
...
This Knowledge of Documents record defines the acceptable document evidence, validation rules, acceptance criteria, rejection criteria, and common errors for Payments activity under KOD-Payments-003. It is used by Operations Officer, Operations Manager, Compliance Officer, Senior Compliance Officer, AML Analyst, and Credit Risk Officer roles where the related policy and SOP require documentary evidence.
...
| --- | --- | --- |
| [POL-Payments-003](../policies/POL-Payments-003_IMPS_and_UPI_Processing_Policy.md) | IMPS and UPI Processing Policy | KOD evidence reference |
| [SOP-Payments-003](../sops/SOP-Payments-003_IMPS_and_UPI_Payment_Processing_SOP.md) | IMPS and UPI Payment Processing SOP | KOD evidence reference |
| [EXM-Payments-003](../exception_matrices/EXM-Payments-003_ACH_Payment_Exception_Matrix.md) | ACH Payment Exception Matrix | KOD evidence reference |

## 9 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for KOD-Payments-003 ACH Mandate Documentation KOD. | Chief Compliance Officer |
