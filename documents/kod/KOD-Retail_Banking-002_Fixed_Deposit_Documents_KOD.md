...
title: "Fixed Deposit Documents KOD"
...
This Knowledge of Documents record defines the acceptable document evidence, validation rules, acceptance criteria, rejection criteria, and common errors for Retail Banking activity under KOD-Retail Banking-002. It is used by Operations Officer, Operations Manager, Compliance Officer, Senior Compliance Officer, AML Analyst, and Credit Risk Officer roles where the related policy and SOP require documentary evidence.
...
| --- | --- | --- |
| [POL-Retail Banking-002](../policies/POL-Retail_Banking-002_Current_Account_Servicing_Policy.md) | Current Account Servicing Policy | KOD evidence reference |
| [SOP-Retail Banking-002](../sops/SOP-Retail_Banking-002_Current_Account_Service_Request_SOP.md) | Current Account Service Request SOP | KOD evidence reference |
| [EXM-Retail Banking-002](../exception_matrices/EXM-Retail_Banking-002_Fixed_Deposit_Exception_Matrix.md) | Fixed Deposit Exception Matrix | KOD evidence reference |

## 9 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for KOD-Retail Banking-002 Fixed Deposit Documents KOD. | Chief Compliance Officer |
