...
title: "Domestic Payment Instruction KOD"
...
keywords:
  ...
  - "SWIFT"
  - "ACH"
  - "domestic payment instruction kod"
  - "KOD-Payments-001"
  - "Domestic"
  - "Payment"
  - "Instruction"
...
This Knowledge of Documents record defines the acceptable document evidence, validation rules, acceptance criteria, rejection criteria, and common errors for Payments activity under KOD-Payments-001. It is used by Operations Officer, Operations Manager, Compliance Officer, Senior Compliance Officer, AML Analyst, and Credit Risk Officer roles where the related policy and SOP require documentary evidence.
...
| --- | --- | --- |
| [POL-Payments-001](../policies/POL-Payments-001_NEFT_Processing_Policy.md) | NEFT Processing Policy | KOD evidence reference |
| [SOP-Payments-001](../sops/SOP-Payments-001_NEFT_Payment_Processing_SOP.md) | NEFT Payment Processing SOP | KOD evidence reference |
| [EXM-Payments-001](../exception_matrices/EXM-Payments-001_Domestic_Payment_Exception_Matrix.md) | Domestic Payment Exception Matrix | KOD evidence reference |

## 9 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for KOD-Payments-001 Domestic Payment Instruction KOD. | Chief Compliance Officer |
