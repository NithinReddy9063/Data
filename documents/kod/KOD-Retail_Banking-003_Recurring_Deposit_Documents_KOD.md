...
title: "Recurring Deposit Documents KOD"
...
keywords:
  ...
  - "salary account"
  - "deposit servicing"
  - "recurring deposit documents kod"
  - "KOD-Retail"
  - "Banking-003"
  - "Recurring"
  - "Deposit"
...
This Knowledge of Documents record defines the acceptable document evidence, validation rules, acceptance criteria, rejection criteria, and common errors for Retail Banking activity under KOD-Retail Banking-003. It is used by Operations Officer, Operations Manager, Compliance Officer, Senior Compliance Officer, AML Analyst, and Credit Risk Officer roles where the related policy and SOP require documentary evidence.
...
| --- | --- | --- |
| [POL-Retail Banking-003](../policies/POL-Retail_Banking-003_Salary_Account_Servicing_Policy.md) | Salary Account Servicing Policy | KOD evidence reference |
| [SOP-Retail Banking-003](../sops/SOP-Retail_Banking-003_Salary_Account_Service_Request_SOP.md) | Salary Account Service Request SOP | KOD evidence reference |
| [EXM-Retail Banking-003](../exception_matrices/EXM-Retail_Banking-003_Recurring_Deposit_Exception_Matrix.md) | Recurring Deposit Exception Matrix | KOD evidence reference |

## 9 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for KOD-Retail Banking-003 Recurring Deposit Documents KOD. | Chief Compliance Officer |
