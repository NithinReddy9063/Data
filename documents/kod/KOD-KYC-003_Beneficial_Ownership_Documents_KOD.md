...
title: "Beneficial Ownership Documents KOD"
...
keywords:
  ...
  - "verification"
  - "beneficial ownership documents kod"
  - "KOD-KYC-003"
  - "Beneficial"
  - "Ownership"
related_documents:
  ...
  - document_id: "SOP-KYC-003"
    path: "documents/sops/SOP-KYC-003_Enhanced_Due_Diligence_Review_SOP.md"
...
This Knowledge of Documents record defines the acceptable document evidence, validation rules, acceptance criteria, rejection criteria, and common errors for KYC activity under KOD-KYC-003. It is used by Operations Officer, Operations Manager, Compliance Officer, Senior Compliance Officer, AML Analyst, and Credit Risk Officer roles where the related policy and SOP require documentary evidence.
...
| --- | --- | --- |
| [POL-KYC-003](../policies/POL-KYC-003_Enhanced_Due_Diligence_Policy.md) | Enhanced Due Diligence Policy | KOD evidence reference |
| [SOP-KYC-003](../sops/SOP-KYC-003_Enhanced_Due_Diligence_Review_SOP.md) | Enhanced Due Diligence Review SOP | KOD evidence reference |
| [EXM-KYC-003](../exception_matrices/EXM-KYC-003_Beneficial_Ownership_Exception_Matrix.md) | Beneficial Ownership Exception Matrix | KOD evidence reference |

## 9 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for KOD-KYC-003 Beneficial Ownership Documents KOD. | Chief Compliance Officer |
