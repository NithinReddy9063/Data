...
title: "Cash Management Documents KOD"
...
This Knowledge of Documents record defines the acceptable document evidence, validation rules, acceptance criteria, rejection criteria, and common errors for Corporate Banking activity under KOD-Corporate Banking-003. It is used by Operations Officer, Operations Manager, Compliance Officer, Senior Compliance Officer, AML Analyst, and Credit Risk Officer roles where the related policy and SOP require documentary evidence.
...
| --- | --- | --- |
| [POL-Corporate Banking-003](../policies/POL-Corporate_Banking-003_Cash_Management_Service_Policy.md) | Cash Management Service Policy | KOD evidence reference |
| [SOP-Corporate Banking-003](../sops/SOP-Corporate_Banking-003_Cash_Management_Service_SOP.md) | Cash Management Service SOP | KOD evidence reference |
| [EXM-Corporate Banking-003](../exception_matrices/EXM-Corporate_Banking-003_Cash_Management_Exception_Matrix.md) | Cash Management Exception Matrix | KOD evidence reference |

## 9 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for KOD-Corporate Banking-003 Cash Management Documents KOD. | Chief Compliance Officer |
