...
title: "High Risk Onboarding Evidence KOD"
...
keywords:
  ...
  - "data quality"
  - "approval routing"
  - "high risk onboarding evidence kod"
  - "KOD-Customer"
  - "Onboarding-004"
  - "High"
  - "Risk"
...
This Knowledge of Documents record defines the acceptable document evidence, validation rules, acceptance criteria, rejection criteria, and common errors for Customer Onboarding activity under KOD-Customer Onboarding-004. It is used by Operations Officer, Operations Manager, Compliance Officer, Senior Compliance Officer, AML Analyst, and Credit Risk Officer roles where the related policy and SOP require documentary evidence.
...
| --- | --- | --- |
| [POL-Customer Onboarding-004](../policies/POL-Customer_Onboarding-004_High_Risk_Onboarding_Policy.md) | High Risk Onboarding Policy | KOD evidence reference |
| [SOP-Customer Onboarding-004](../sops/SOP-Customer_Onboarding-004_High_Risk_Onboarding_Review_SOP.md) | High Risk Onboarding Review SOP | KOD evidence reference |
| [EXM-Customer Onboarding-004](../exception_matrices/EXM-Customer_Onboarding-004_High_Risk_Onboarding_Exception_Matrix.md) | High Risk Onboarding Exception Matrix | KOD evidence reference |

## 9 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for KOD-Customer Onboarding-004 High Risk Onboarding Evidence KOD. | Chief Compliance Officer |
