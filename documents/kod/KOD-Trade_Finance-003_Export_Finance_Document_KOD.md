...
title: "Export Finance Document KOD"
...
This Knowledge of Documents record defines the acceptable document evidence, validation rules, acceptance criteria, rejection criteria, and common errors for Trade Finance activity under KOD-Trade Finance-003. It is used by Operations Officer, Operations Manager, Compliance Officer, Senior Compliance Officer, AML Analyst, and Credit Risk Officer roles where the related policy and SOP require documentary evidence.
...
| --- | --- | --- |
| [POL-Trade Finance-003](../policies/POL-Trade_Finance-003_Export_Finance_Control_Policy.md) | Export Finance Control Policy | KOD evidence reference |
| [SOP-Trade Finance-003](../sops/SOP-Trade_Finance-003_Export_Finance_Processing_SOP.md) | Export Finance Processing SOP | KOD evidence reference |
| [EXM-Trade Finance-003](../exception_matrices/EXM-Trade_Finance-003_Export_Finance_Exception_Matrix.md) | Export Finance Exception Matrix | KOD evidence reference |

## 9 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for KOD-Trade Finance-003 Export Finance Document KOD. | Chief Compliance Officer |
