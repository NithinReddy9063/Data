...
title: "Business Loan Document KOD"
...
This Knowledge of Documents record defines the acceptable document evidence, validation rules, acceptance criteria, rejection criteria, and common errors for Credit activity under KOD-Credit-002. It is used by Operations Officer, Operations Manager, Compliance Officer, Senior Compliance Officer, AML Analyst, and Credit Risk Officer roles where the related policy and SOP require documentary evidence.
...
| --- | --- | --- |
| [POL-Credit-002](../policies/POL-Credit-002_Personal_Loan_Credit_Assessment_Policy.md) | Personal Loan Credit Assessment Policy | KOD evidence reference |
| [SOP-Credit-002](../sops/SOP-Credit-002_Personal_Loan_Credit_Assessment_SOP.md) | Personal Loan Credit Assessment SOP | KOD evidence reference |
| [EXM-Credit-002](../exception_matrices/EXM-Credit-002_Business_Loan_Exception_Matrix.md) | Business Loan Exception Matrix | KOD evidence reference |

## 9 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for KOD-Credit-002 Business Loan Document KOD. | Chief Compliance Officer |
