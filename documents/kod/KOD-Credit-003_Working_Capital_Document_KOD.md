...
title: "Working Capital Document KOD"
...
This Knowledge of Documents record defines the acceptable document evidence, validation rules, acceptance criteria, rejection criteria, and common errors for Credit activity under KOD-Credit-003. It is used by Operations Officer, Operations Manager, Compliance Officer, Senior Compliance Officer, AML Analyst, and Credit Risk Officer roles where the related policy and SOP require documentary evidence.
...
| --- | --- | --- |
| [POL-Credit-003](../policies/POL-Credit-003_Business_Loan_Credit_Assessment_Policy.md) | Business Loan Credit Assessment Policy | KOD evidence reference |
| [SOP-Credit-003](../sops/SOP-Credit-003_Business_Loan_Credit_Assessment_SOP.md) | Business Loan Credit Assessment SOP | KOD evidence reference |
| [EXM-Credit-003](../exception_matrices/EXM-Credit-003_Working_Capital_Exception_Matrix.md) | Working Capital Exception Matrix | KOD evidence reference |

## 9 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for KOD-Credit-003 Working Capital Document KOD. | Chief Compliance Officer |
