...
title: "Non-Individual Constitution Documents KOD"
...
keywords:
  ...
  - "verification"
  - "non-individual constitution documents kod"
  - "KOD-KYC-002"
  - "Non-Individual"
  - "Constitution"
related_documents:
  - document_id: "POL-KYC-002"
    path: "documents/policies/POL-KYC-002_Customer_Due_Diligence_Policy.md"
  - document_id: "SOP-KYC-002"
    path: "documents/sops/SOP-KYC-002_Customer_Due_Diligence_Review_SOP.md"
  - document_id: "EXM-KYC-002"
    path: "documents/exception_matrices/EXM-KYC-002_Address_Proof_Exception_Matrix.md"
supersedes: null
synthetic: true
---
# Non-Individual Constitution Documents KOD
...
This Knowledge of Documents record defines the acceptable document evidence, validation rules, acceptance criteria, rejection criteria, and common errors for KYC activity under KOD-KYC-002. It is used by Operations Officer, Operations Manager, Compliance Officer, Senior Compliance Officer, AML Analyst, and Credit Risk Officer roles where the related policy and SOP require documentary evidence.
...
| --- | --- | --- |
| [POL-KYC-002](../policies/POL-KYC-002_Customer_Due_Diligence_Policy.md) | Customer Due Diligence Policy | KOD evidence reference |
| [SOP-KYC-002](../sops/SOP-KYC-002_Customer_Due_Diligence_Review_SOP.md) | Customer Due Diligence Review SOP | KOD evidence reference |
| [EXM-KYC-002](../exception_matrices/EXM-KYC-002_Address_Proof_Exception_Matrix.md) | Address Proof Exception Matrix | KOD evidence reference |

## 9 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for KOD-KYC-002 Non-Individual Constitution Documents KOD. | Chief Compliance Officer |
