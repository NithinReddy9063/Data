...
title: "Business Current Account Documents KOD"
...
keywords:
  ...
  - "escrow account"
  - "cash management"
  - "business current account documents kod"
  - "KOD-Corporate"
  - "Banking-001"
  - "Business"
  - "Current"
...
This Knowledge of Documents record defines the acceptable document evidence, validation rules, acceptance criteria, rejection criteria, and common errors for Corporate Banking activity under KOD-Corporate Banking-001. It is used by Operations Officer, Operations Manager, Compliance Officer, Senior Compliance Officer, AML Analyst, and Credit Risk Officer roles where the related policy and SOP require documentary evidence.
...
| --- | --- | --- |
| [POL-Corporate Banking-001](../policies/POL-Corporate_Banking-001_Business_Current_Account_Servicing_Policy.md) | Business Current Account Servicing Policy | KOD evidence reference |
| [SOP-Corporate Banking-001](../sops/SOP-Corporate_Banking-001_Business_Current_Account_Service_SOP.md) | Business Current Account Service SOP | KOD evidence reference |
| [EXM-Corporate Banking-001](../exception_matrices/EXM-Corporate_Banking-001_Business_Current_Account_Exception_Matrix.md) | Business Current Account Exception Matrix | KOD evidence reference |

## 9 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for KOD-Corporate Banking-001 Business Current Account Documents KOD. | Chief Compliance Officer |
