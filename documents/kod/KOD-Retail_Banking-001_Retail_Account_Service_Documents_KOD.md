...
title: "Retail Account Service Documents KOD"
...
keywords:
  ...
  - "salary account"
  - "deposit servicing"
  - "retail account service documents kod"
  - "KOD-Retail"
  - "Banking-001"
  - "Retail"
  - "Account"
...
This Knowledge of Documents record defines the acceptable document evidence, validation rules, acceptance criteria, rejection criteria, and common errors for Retail Banking activity under KOD-Retail Banking-001. It is used by Operations Officer, Operations Manager, Compliance Officer, Senior Compliance Officer, AML Analyst, and Credit Risk Officer roles where the related policy and SOP require documentary evidence.
...
| --- | --- | --- |
| [POL-Retail Banking-001](../policies/POL-Retail_Banking-001_Savings_Account_Servicing_Policy.md) | Savings Account Servicing Policy | KOD evidence reference |
| [SOP-Retail Banking-001](../sops/SOP-Retail_Banking-001_Savings_Account_Service_Request_SOP.md) | Savings Account Service Request SOP | KOD evidence reference |
| [EXM-Retail Banking-001](../exception_matrices/EXM-Retail_Banking-001_Retail_Account_Service_Exception_Matrix.md) | Retail Account Service Exception Matrix | KOD evidence reference |

## 9 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for KOD-Retail Banking-001 Retail Account Service Documents KOD. | Chief Compliance Officer |
