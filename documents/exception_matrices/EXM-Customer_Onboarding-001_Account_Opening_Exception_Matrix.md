...
title: "Account Opening Exception Matrix"
...
keywords:
  ...
  - "data quality"
  - "approval routing"
  - "account opening exception matrix"
  - "EXM-Customer"
  - "Onboarding-001"
  - "Account"
  - "Opening"
...
| --- | --- | --- |
| [POL-Customer Onboarding-001](../policies/POL-Customer_Onboarding-001_Standard_Account_Opening_Policy.md) | Standard Account Opening Policy | Exception matrix reference |
| [SOP-Customer Onboarding-001](../sops/SOP-Customer_Onboarding-001_Standard_Account_Opening_SOP.md) | Standard Account Opening SOP | Exception matrix reference |
| [KOD-Customer Onboarding-001](../kod/KOD-Customer_Onboarding-001_Account_Opening_Form_KOD.md) | Account Opening Form KOD | Exception matrix reference |
| [FAQ-Customer Onboarding-001](../case_repository/FAQ-Customer_Onboarding-001_Account_Opening_Form_Correction.md) | Account Opening Form Correction | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-Customer Onboarding-001 Account Opening Exception Matrix. | Chief Compliance Officer |
