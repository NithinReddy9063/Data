...
title: "Suspicious Activity Escalation Exception Matrix"
...
keywords:
  ...
  - "suspicious activity escalation exception matrix"
  - "EXM-AML-003"
  - "Suspicious"
  - "Activity"
  - "Escalation"
...
| Domain-specific review | AML Investigation - 3 Business Days | Apply the domain SLA where it is more specific to the case. |
...
| --- | --- | --- |
| [POL-AML-003](../policies/POL-AML-003_Suspicious_Activity_Review_Policy.md) | Suspicious Activity Review Policy | Exception matrix reference |
| [SOP-AML-003](../sops/SOP-AML-003_Suspicious_Activity_Assessment_SOP.md) | Suspicious Activity Assessment SOP | Exception matrix reference |
| [KOD-AML-003](../kod/KOD-AML-003_Suspicious_Activity_Case_Documents_KOD.md) | Suspicious Activity Case Documents KOD | Exception matrix reference |
| [FAQ-AML-003](../case_repository/FAQ-AML-003_High_Risk_Customer_Monitoring_Question.md) | High Risk Customer Monitoring Question | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-AML-003 Suspicious Activity Escalation Exception Matrix. | Chief Compliance Officer |
