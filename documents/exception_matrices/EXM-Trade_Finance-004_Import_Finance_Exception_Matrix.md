...
title: "Import Finance Exception Matrix"
...
keywords:
  ...
  - "export finance"
  - "import finance"
  - "import finance exception matrix"
  - "EXM-Trade"
  - "Finance-004"
  - "Import"
  - "Finance"
...
| Domain-specific review | Trade Transaction Review - 1 Business Day | Apply the domain SLA where it is more specific to the case. |
...
| --- | --- | --- |
| [POL-Trade Finance-004](../policies/POL-Trade_Finance-004_Import_Finance_Control_Policy.md) | Import Finance Control Policy | Exception matrix reference |
| [SOP-Trade Finance-004](../sops/SOP-Trade_Finance-004_Import_Finance_Processing_SOP.md) | Import Finance Processing SOP | Exception matrix reference |
| [KOD-Trade Finance-004](../kod/KOD-Trade_Finance-004_Import_Finance_and_Documentary_Collection_KOD.md) | Import Finance and Documentary Collection KOD | Exception matrix reference |
| [FAQ-Trade Finance-004](../case_repository/FAQ-Trade_Finance-004_Import_Finance_Invoice_Discrepancy.md) | Import Finance Invoice Discrepancy | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-Trade Finance-004 Import Finance Exception Matrix. | Chief Compliance Officer |
