...
title: "Payment Reversal Exception Matrix"
...
keywords:
  ...
  - "SWIFT"
  - "ACH"
  - "payment reversal exception matrix"
  - "EXM-Payments-004"
  - "Payment"
  - "Reversal"
  - "Exception"
...
| --- | --- | --- |
| [POL-Payments-004](../policies/POL-Payments-004_SWIFT_Payment_Control_Policy.md) | SWIFT Payment Control Policy | Exception matrix reference |
| [SOP-Payments-004](../sops/SOP-Payments-004_SWIFT_Payment_Processing_SOP.md) | SWIFT Payment Processing SOP | Exception matrix reference |
| [KOD-Payments-004](../kod/KOD-Payments-004_Payment_Exception_Evidence_KOD.md) | Payment Exception Evidence KOD | Exception matrix reference |
| [FAQ-Payments-004](../case_repository/FAQ-Payments-004_SWIFT_Message_Detail_Difference.md) | SWIFT Message Detail Difference | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-Payments-004 Payment Reversal Exception Matrix. | Chief Compliance Officer |
