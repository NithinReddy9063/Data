...
title: "Business Loan Exception Matrix"
...
keywords:
  ...
  - "working capital"
  - "overdraft"
  - "business loan exception matrix"
  - "EXM-Credit-002"
  - "Business"
  - "Loan"
  - "Exception"
...
| --- | --- | --- |
| [POL-Credit-002](../policies/POL-Credit-002_Personal_Loan_Credit_Assessment_Policy.md) | Personal Loan Credit Assessment Policy | Exception matrix reference |
| [SOP-Credit-002](../sops/SOP-Credit-002_Personal_Loan_Credit_Assessment_SOP.md) | Personal Loan Credit Assessment SOP | Exception matrix reference |
| [KOD-Credit-002](../kod/KOD-Credit-002_Business_Loan_Document_KOD.md) | Business Loan Document KOD | Exception matrix reference |
| [FAQ-Credit-002](../case_repository/FAQ-Credit-002_Personal_Loan_Address_Difference.md) | Personal Loan Address Difference | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-Credit-002 Business Loan Exception Matrix. | Chief Compliance Officer |
