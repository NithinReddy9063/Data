...
title: "Recurring Deposit Exception Matrix"
...
keywords:
  ...
  - "salary account"
  - "deposit servicing"
  - "recurring deposit exception matrix"
  - "EXM-Retail"
  - "Banking-003"
  - "Recurring"
  - "Deposit"
...
| Domain-specific review | Complaint Resolution - 3 Business Days | Apply the domain SLA where it is more specific to the case. |
...
| --- | --- | --- |
| [POL-Retail Banking-003](../policies/POL-Retail_Banking-003_Salary_Account_Servicing_Policy.md) | Salary Account Servicing Policy | Exception matrix reference |
| [SOP-Retail Banking-003](../sops/SOP-Retail_Banking-003_Salary_Account_Service_Request_SOP.md) | Salary Account Service Request SOP | Exception matrix reference |
| [KOD-Retail Banking-003](../kod/KOD-Retail_Banking-003_Recurring_Deposit_Documents_KOD.md) | Recurring Deposit Documents KOD | Exception matrix reference |
| [FAQ-Retail Banking-003](../case_repository/FAQ-Retail_Banking-003_Salary_Account_Employer_Detail_Update.md) | Salary Account Employer Detail Update | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-Retail Banking-003 Recurring Deposit Exception Matrix. | Chief Compliance Officer |
