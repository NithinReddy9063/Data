...
title: "Overdraft Exception Matrix"
...
| --- | --- | --- |
| [POL-Credit-004](../policies/POL-Credit-004_Working_Capital_Credit_Control_Policy.md) | Working Capital Credit Control Policy | Exception matrix reference |
| [SOP-Credit-004](../sops/SOP-Credit-004_Working_Capital_Review_SOP.md) | Working Capital Review SOP | Exception matrix reference |
| [KOD-Credit-004](../kod/KOD-Credit-004_Overdraft_Document_KOD.md) | Overdraft Document KOD | Exception matrix reference |
| [FAQ-Credit-004](../case_repository/FAQ-Credit-004_Working_Capital_Limit_Review_Scenario.md) | Working Capital Limit Review Scenario | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-Credit-004 Overdraft Exception Matrix. | Chief Compliance Officer |
