...
title: "Consent Capture Exception Matrix"
...
keywords:
  ...
  - "data quality"
  - "approval routing"
  - "consent capture exception matrix"
  - "EXM-Customer"
  - "Onboarding-002"
  - "Capture"
  - "Exception"
...
| --- | --- | --- |
| [POL-Customer Onboarding-002](../policies/POL-Customer_Onboarding-002_Customer_Onboarding_Documentation_Policy.md) | Customer Onboarding Documentation Policy | Exception matrix reference |
| [SOP-Customer Onboarding-002](../sops/SOP-Customer_Onboarding-002_Onboarding_Document_Collection_SOP.md) | Onboarding Document Collection SOP | Exception matrix reference |
| [KOD-Customer Onboarding-002](../kod/KOD-Customer_Onboarding-002_Customer_Consent_Document_KOD.md) | Customer Consent Document KOD | Exception matrix reference |
| [FAQ-Customer Onboarding-002](../case_repository/FAQ-Customer_Onboarding-002_Missing_Consent_Capture_Scenario.md) | Missing Consent Capture Scenario | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-Customer Onboarding-002 Consent Capture Exception Matrix. | Chief Compliance Officer |
