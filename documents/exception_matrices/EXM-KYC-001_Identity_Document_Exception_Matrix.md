...
title: "Identity Document Exception Matrix"
...
keywords:
  ...
  - "verification"
  - "identity document exception matrix"
  - "EXM-KYC-001"
  - "Identity"
  - "Exception"
related_documents:
...
| --- | --- | --- |
| [POL-KYC-001](../policies/POL-KYC-001_Customer_Identification_and_Verification_Policy.md) | Customer Identification and Verification Policy | Exception matrix reference |
| [SOP-KYC-001](../sops/SOP-KYC-001_Customer_Identity_Verification_SOP.md) | Customer Identity Verification SOP | Exception matrix reference |
| [KOD-KYC-001](../kod/KOD-KYC-001_Individual_Identity_and_Address_Documents_KOD.md) | Individual Identity and Address Documents KOD | Exception matrix reference |
| [FAQ-KYC-001](../case_repository/FAQ-KYC-001_Address_Mismatch_During_Account_Opening.md) | Address Mismatch During Account Opening | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-KYC-001 Identity Document Exception Matrix. | Chief Compliance Officer |
