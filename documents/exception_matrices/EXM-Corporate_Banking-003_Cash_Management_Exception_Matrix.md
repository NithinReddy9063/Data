...
title: "Cash Management Exception Matrix"
...
keywords:
  ...
  - "escrow account"
  - "cash management"
  - "cash management exception matrix"
  - "EXM-Corporate"
  - "Banking-003"
  - "Cash"
  - "Management"
...
| --- | --- | --- |
| [POL-Corporate Banking-003](../policies/POL-Corporate_Banking-003_Cash_Management_Service_Policy.md) | Cash Management Service Policy | Exception matrix reference |
| [SOP-Corporate Banking-003](../sops/SOP-Corporate_Banking-003_Cash_Management_Service_SOP.md) | Cash Management Service SOP | Exception matrix reference |
| [KOD-Corporate Banking-003](../kod/KOD-Corporate_Banking-003_Cash_Management_Documents_KOD.md) | Cash Management Documents KOD | Exception matrix reference |
| [FAQ-Corporate Banking-003](../case_repository/FAQ-Corporate_Banking-003_Cash_Management_Setup_Clarification.md) | Cash Management Setup Clarification | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-Corporate Banking-003 Cash Management Exception Matrix. | Chief Compliance Officer |
