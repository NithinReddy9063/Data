...
title: "Periodic Review Exception Matrix"
...
keywords:
  ...
  - "verification"
  - "periodic review exception matrix"
  - "EXM-KYC-004"
  - "Periodic"
  - "Review"
  - "Exception"
...
| --- | --- | --- |
| [POL-KYC-004](../policies/POL-KYC-004_Beneficial_Ownership_Identification_Policy.md) | Beneficial Ownership Identification Policy | Exception matrix reference |
| [SOP-KYC-004](../sops/SOP-KYC-004_Beneficial_Ownership_Capture_SOP.md) | Beneficial Ownership Capture SOP | Exception matrix reference |
| [KOD-KYC-004](../kod/KOD-KYC-004_KYC_Review_Supporting_Documents_KOD.md) | KYC Review Supporting Documents KOD | Exception matrix reference |
| [FAQ-KYC-004](../case_repository/FAQ-KYC-004_NRI_Identity_Validation_Query.md) | NRI Identity Validation Query | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-KYC-004 Periodic Review Exception Matrix. | Chief Compliance Officer |
