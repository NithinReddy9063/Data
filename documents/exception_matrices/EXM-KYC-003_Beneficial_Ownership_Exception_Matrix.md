...
title: "Beneficial Ownership Exception Matrix"
...
keywords:
  ...
  - "verification"
  - "beneficial ownership exception matrix"
  - "EXM-KYC-003"
  - "Beneficial"
  - "Ownership"
  - "Exception"
...
| --- | --- | --- |
| [POL-KYC-003](../policies/POL-KYC-003_Enhanced_Due_Diligence_Policy.md) | Enhanced Due Diligence Policy | Exception matrix reference |
| [SOP-KYC-003](../sops/SOP-KYC-003_Enhanced_Due_Diligence_Review_SOP.md) | Enhanced Due Diligence Review SOP | Exception matrix reference |
| [KOD-KYC-003](../kod/KOD-KYC-003_Beneficial_Ownership_Documents_KOD.md) | Beneficial Ownership Documents KOD | Exception matrix reference |
| [FAQ-KYC-003](../case_repository/FAQ-KYC-003_Missing_Beneficial_Owner_Percentage.md) | Missing Beneficial Owner Percentage | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-KYC-003 Beneficial Ownership Exception Matrix. | Chief Compliance Officer |
