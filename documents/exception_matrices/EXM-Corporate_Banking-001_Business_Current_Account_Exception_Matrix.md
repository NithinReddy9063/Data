...
title: "Business Current Account Exception Matrix"
...
keywords:
  ...
  - "escrow account"
  - "cash management"
  - "business current account exception matrix"
  - "EXM-Corporate"
  - "Banking-001"
  - "Business"
  - "Current"
...
| --- | --- | --- |
| [POL-Corporate Banking-001](../policies/POL-Corporate_Banking-001_Business_Current_Account_Servicing_Policy.md) | Business Current Account Servicing Policy | Exception matrix reference |
| [SOP-Corporate Banking-001](../sops/SOP-Corporate_Banking-001_Business_Current_Account_Service_SOP.md) | Business Current Account Service SOP | Exception matrix reference |
| [KOD-Corporate Banking-001](../kod/KOD-Corporate_Banking-001_Business_Current_Account_Documents_KOD.md) | Business Current Account Documents KOD | Exception matrix reference |
| [FAQ-Corporate Banking-001](../case_repository/FAQ-Corporate_Banking-001_Business_Current_Account_Signatory_Update.md) | Business Current Account Signatory Update | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-Corporate Banking-001 Business Current Account Exception Matrix. | Chief Compliance Officer |
