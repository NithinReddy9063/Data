...
title: "ACH Payment Exception Matrix"
...
| --- | --- | --- |
| [POL-Payments-003](../policies/POL-Payments-003_IMPS_and_UPI_Processing_Policy.md) | IMPS and UPI Processing Policy | Exception matrix reference |
| [SOP-Payments-003](../sops/SOP-Payments-003_IMPS_and_UPI_Payment_Processing_SOP.md) | IMPS and UPI Payment Processing SOP | Exception matrix reference |
| [KOD-Payments-003](../kod/KOD-Payments-003_ACH_Mandate_Documentation_KOD.md) | ACH Mandate Documentation KOD | Exception matrix reference |
| [FAQ-Payments-003](../case_repository/FAQ-Payments-003_UPI_Payment_Failure_Clarification.md) | UPI Payment Failure Clarification | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-Payments-003 ACH Payment Exception Matrix. | Chief Compliance Officer |
