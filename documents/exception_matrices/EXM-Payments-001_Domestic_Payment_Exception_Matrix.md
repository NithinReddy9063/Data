...
title: "Domestic Payment Exception Matrix"
...
keywords:
  ...
  - "SWIFT"
  - "ACH"
  - "domestic payment exception matrix"
  - "EXM-Payments-001"
  - "Domestic"
  - "Payment"
  - "Exception"
...
| --- | --- | --- |
| [POL-Payments-001](../policies/POL-Payments-001_NEFT_Processing_Policy.md) | NEFT Processing Policy | Exception matrix reference |
| [SOP-Payments-001](../sops/SOP-Payments-001_NEFT_Payment_Processing_SOP.md) | NEFT Payment Processing SOP | Exception matrix reference |
| [KOD-Payments-001](../kod/KOD-Payments-001_Domestic_Payment_Instruction_KOD.md) | Domestic Payment Instruction KOD | Exception matrix reference |
| [FAQ-Payments-001](../case_repository/FAQ-Payments-001_NEFT_Beneficiary_Detail_Correction.md) | NEFT Beneficiary Detail Correction | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-Payments-001 Domestic Payment Exception Matrix. | Chief Compliance Officer |
