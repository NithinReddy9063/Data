...
title: "Working Capital Exception Matrix"
...
keywords:
  ...
  - "working capital"
  - "overdraft"
  - "working capital exception matrix"
  - "EXM-Credit-003"
  - "Working"
  - "Capital"
  - "Exception"
...
| Domain-specific review | High Risk Review - 5 Business Days | Apply the domain SLA where it is more specific to the case. |
...
| --- | --- | --- |
| [POL-Credit-003](../policies/POL-Credit-003_Business_Loan_Credit_Assessment_Policy.md) | Business Loan Credit Assessment Policy | Exception matrix reference |
| [SOP-Credit-003](../sops/SOP-Credit-003_Business_Loan_Credit_Assessment_SOP.md) | Business Loan Credit Assessment SOP | Exception matrix reference |
| [KOD-Credit-003](../kod/KOD-Credit-003_Working_Capital_Document_KOD.md) | Working Capital Document KOD | Exception matrix reference |
| [FAQ-Credit-003](../case_repository/FAQ-Credit-003_Business_Loan_Ownership_Evidence_Query.md) | Business Loan Ownership Evidence Query | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-Credit-003 Working Capital Exception Matrix. | Chief Compliance Officer |
