...
title: "Transaction Monitoring Exception Matrix"
...
keywords:
  ...
  - "transaction monitoring exception matrix"
  - "EXM-AML-002"
  - "Transaction"
  - "Monitoring"
  - "Exception"
...
| --- | --- | --- |
| [POL-AML-002](../policies/POL-AML-002_Sanctions_Screening_Policy.md) | Sanctions Screening Policy | Exception matrix reference |
| [SOP-AML-002](../sops/SOP-AML-002_Sanctions_Alert_Review_SOP.md) | Sanctions Alert Review SOP | Exception matrix reference |
| [KOD-AML-002](../kod/KOD-AML-002_Sanctions_Match_Documentation_KOD.md) | Sanctions Match Documentation KOD | Exception matrix reference |
| [FAQ-AML-002](../case_repository/FAQ-AML-002_Structuring_Alert_Review_Clarification.md) | Structuring Alert Review Clarification | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-AML-002 Transaction Monitoring Exception Matrix. | Chief Compliance Officer |
