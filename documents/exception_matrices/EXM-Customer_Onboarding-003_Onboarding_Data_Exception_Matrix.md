...
title: "Onboarding Data Exception Matrix"
...
keywords:
  ...
  - "data quality"
  - "approval routing"
  - "onboarding data exception matrix"
  - "EXM-Customer"
  - "Onboarding-003"
  - "Onboarding"
  - "Data"
...
| Domain-specific review | Standard Account Opening - 2 Business Days | Apply the domain SLA where it is more specific to the case. |
...
| --- | --- | --- |
| [POL-Customer Onboarding-003](../policies/POL-Customer_Onboarding-003_Customer_Onboarding_Approval_Policy.md) | Customer Onboarding Approval Policy | Exception matrix reference |
| [SOP-Customer Onboarding-003](../sops/SOP-Customer_Onboarding-003_Onboarding_Approval_Routing_SOP.md) | Onboarding Approval Routing SOP | Exception matrix reference |
| [KOD-Customer Onboarding-003](../kod/KOD-Customer_Onboarding-003_Onboarding_Supporting_Document_KOD.md) | Onboarding Supporting Document KOD | Exception matrix reference |
| [FAQ-Customer Onboarding-003](../case_repository/FAQ-Customer_Onboarding-003_High_Risk_Onboarding_Approval_Delay.md) | High Risk Onboarding Approval Delay | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-Customer Onboarding-003 Onboarding Data Exception Matrix. | Chief Compliance Officer |
