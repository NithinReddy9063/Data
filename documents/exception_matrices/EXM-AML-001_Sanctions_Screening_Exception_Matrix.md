...
title: "Sanctions Screening Exception Matrix"
...
keywords:
  ...
  - "sanctions screening exception matrix"
  - "EXM-AML-001"
  - "Exception"
related_documents:
...
| --- | --- | --- |
| [POL-AML-001](../policies/POL-AML-001_AML_Customer_Screening_Policy.md) | AML Customer Screening Policy | Exception matrix reference |
| [SOP-AML-001](../sops/SOP-AML-001_Customer_Name_Screening_SOP.md) | Customer Name Screening SOP | Exception matrix reference |
| [KOD-AML-001](../kod/KOD-AML-001_AML_Customer_Screening_Evidence_KOD.md) | AML Customer Screening Evidence KOD | Exception matrix reference |
| [FAQ-AML-001](../case_repository/FAQ-AML-001_Potential_Sanctions_Name_Match_Resolution.md) | Potential Sanctions Name Match Resolution | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-AML-001 Sanctions Screening Exception Matrix. | Chief Compliance Officer |
