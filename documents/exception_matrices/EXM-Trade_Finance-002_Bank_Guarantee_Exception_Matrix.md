...
title: "Bank Guarantee Exception Matrix"
...
keywords:
  ...
  - "export finance"
  - "import finance"
  - "bank guarantee exception matrix"
  - "EXM-Trade"
  - "Finance-002"
  - "Bank"
  - "Guarantee"
...
| --- | --- | --- |
| [POL-Trade Finance-002](../policies/POL-Trade_Finance-002_Bank_Guarantee_Issuance_Policy.md) | Bank Guarantee Issuance Policy | Exception matrix reference |
| [SOP-Trade Finance-002](../sops/SOP-Trade_Finance-002_Bank_Guarantee_Issuance_SOP.md) | Bank Guarantee Issuance SOP | Exception matrix reference |
| [KOD-Trade Finance-002](../kod/KOD-Trade_Finance-002_Bank_Guarantee_Document_KOD.md) | Bank Guarantee Document KOD | Exception matrix reference |
| [FAQ-Trade Finance-002](../case_repository/FAQ-Trade_Finance-002_Bank_Guarantee_Margin_Confirmation.md) | Bank Guarantee Margin Confirmation | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-Trade Finance-002 Bank Guarantee Exception Matrix. | Chief Compliance Officer |
