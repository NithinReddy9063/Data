...
title: "Escrow Account Exception Matrix"
...
keywords:
  ...
  - "escrow account"
  - "cash management"
  - "escrow account exception matrix"
  - "EXM-Corporate"
  - "Banking-002"
  - "Escrow"
  - "Account"
...
| --- | --- | --- |
| [POL-Corporate Banking-002](../policies/POL-Corporate_Banking-002_Escrow_Account_Control_Policy.md) | Escrow Account Control Policy | Exception matrix reference |
| [SOP-Corporate Banking-002](../sops/SOP-Corporate_Banking-002_Escrow_Account_Control_SOP.md) | Escrow Account Control SOP | Exception matrix reference |
| [KOD-Corporate Banking-002](../kod/KOD-Corporate_Banking-002_Escrow_Account_Documents_KOD.md) | Escrow Account Documents KOD | Exception matrix reference |
| [FAQ-Corporate Banking-002](../case_repository/FAQ-Corporate_Banking-002_Escrow_Account_Instruction_Query.md) | Escrow Account Instruction Query | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-Corporate Banking-002 Escrow Account Exception Matrix. | Chief Compliance Officer |
