...
title: "Letter of Credit Exception Matrix"
...
keywords:
  ...
  - "export finance"
  - "import finance"
  - "letter of credit exception matrix"
  - "EXM-Trade"
  - "Finance-001"
  - "Letter"
  - "Credit"
...
| --- | --- | --- |
| [POL-Trade Finance-001](../policies/POL-Trade_Finance-001_Letter_of_Credit_Processing_Policy.md) | Letter of Credit Processing Policy | Exception matrix reference |
| [SOP-Trade Finance-001](../sops/SOP-Trade_Finance-001_Letter_of_Credit_Issuance_SOP.md) | Letter of Credit Issuance SOP | Exception matrix reference |
| [KOD-Trade Finance-001](../kod/KOD-Trade_Finance-001_Letter_of_Credit_Document_KOD.md) | Letter of Credit Document KOD | Exception matrix reference |
| [FAQ-Trade Finance-001](../case_repository/FAQ-Trade_Finance-001_Letter_of_Credit_Applicant_Name_Difference.md) | Letter of Credit Applicant Name Difference | Exception matrix reference |

## 8 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for EXM-Trade Finance-001 Letter of Credit Exception Matrix. | Chief Compliance Officer |
