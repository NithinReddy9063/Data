...
title: "Fixed Deposit Premature Closure Query"
...
keywords:
  ...
  - "salary account"
  - "deposit servicing"
  - "fixed deposit premature closure query"
  - "FAQ-Retail"
  - "Banking-004"
  - "Fixed"
  - "Deposit"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-Retail Banking-004](./FAQ-Retail_Banking-004_Fixed_Deposit_Premature_Closure_Query.md) |
| Case Title | Fixed Deposit Premature Closure Query |
| Domain | Retail Banking |
| Owning Department | RET - Retail Banking |
| Case Status | Approved for Operations Knowledge Assistant use |

## 2 Business Context

This case repository record provides approved guidance for an operations question involving retail account servicing, deposit handling, and customer maintenance. It is designed for controlled retrieval by the internal Operations Knowledge Assistant and must be read together with the linked Policy, SOP, KOD, and Exception Matrix records.

## 3 Customer Scenario

A customer or internal user raises a question linked to fixed deposit premature closure query. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Fixed Deposit Premature Closure Query while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-Retail Banking-004](../policies/POL-Retail_Banking-004_Fixed_Deposit_Servicing_Policy.md) | Fixed Deposit Servicing Policy | Case support reference |
| [SOP-Retail Banking-004](../sops/SOP-Retail_Banking-004_Fixed_Deposit_Service_Request_SOP.md) | Fixed Deposit Service Request SOP | Case support reference |
| [EXM-Retail Banking-001](../exception_matrices/EXM-Retail_Banking-001_Retail_Account_Service_Exception_Matrix.md) | Retail Account Service Exception Matrix | Case support reference |
| [KOD-Retail Banking-001](../kod/KOD-Retail_Banking-001_Retail_Account_Service_Documents_KOD.md) | Retail Account Service Documents KOD | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-Retail Banking-004 Fixed Deposit Premature Closure Query. | Chief Compliance Officer |
