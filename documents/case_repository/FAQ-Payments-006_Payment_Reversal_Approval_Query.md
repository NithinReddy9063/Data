...
title: "Payment Reversal Approval Query"
...
keywords:
  ...
  - "SWIFT"
  - "ACH"
  - "payment reversal approval query"
  - "FAQ-Payments-006"
  - "Payment"
  - "Reversal"
  - "Approval"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-Payments-006](./FAQ-Payments-006_Payment_Reversal_Approval_Query.md) |
| Case Title | Payment Reversal Approval Query |
| Domain | Payments |
...
A customer or internal user raises a question linked to payment reversal approval query. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Payment Reversal Approval Query while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-Payments-006](../policies/POL-Payments-006_Payment_Exception_Handling_Policy.md) | Payment Exception Handling Policy | Case support reference |
| [SOP-Payments-006](../sops/SOP-Payments-006_Payment_Exception_Handling_SOP.md) | Payment Exception Handling SOP | Case support reference |
| [EXM-Payments-002](../exception_matrices/EXM-Payments-002_SWIFT_Payment_Exception_Matrix.md) | SWIFT Payment Exception Matrix | Case support reference |
| [KOD-Payments-002](../kod/KOD-Payments-002_SWIFT_Payment_Instruction_KOD.md) | SWIFT Payment Instruction KOD | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-Payments-006 Payment Reversal Approval Query. | Chief Compliance Officer |
