...
title: "Financial Institution Screening Scenario"
...
keywords:
  ...
  - "financial institution screening scenario"
  - "FAQ-AML-008"
  - "Financial"
  - "Institution"
related_documents:
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-AML-008](./FAQ-AML-008_Financial_Institution_Screening_Scenario.md) |
| Case Title | Financial Institution Screening Scenario |
| Domain | AML |
...
A customer or internal user raises a question linked to financial institution screening scenario. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Financial Institution Screening Scenario while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-AML-008 Financial Institution Screening Scenario. | Chief Compliance Officer |
