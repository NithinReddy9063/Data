...
title: "Potential Sanctions Name Match Resolution"
...
keywords:
  ...
  - "potential sanctions name match resolution"
  - "FAQ-AML-001"
  - "Potential"
  - "Name"
  - "Match"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-AML-001](./FAQ-AML-001_Potential_Sanctions_Name_Match_Resolution.md) |
| Case Title | Potential Sanctions Name Match Resolution |
| Domain | AML |
...
A customer or internal user raises a question linked to potential sanctions name match resolution. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Potential Sanctions Name Match Resolution while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-AML-001](../policies/POL-AML-001_AML_Customer_Screening_Policy.md) | AML Customer Screening Policy | Case support reference |
| [SOP-AML-001](../sops/SOP-AML-001_Customer_Name_Screening_SOP.md) | Customer Name Screening SOP | Case support reference |
| [EXM-AML-001](../exception_matrices/EXM-AML-001_Sanctions_Screening_Exception_Matrix.md) | Sanctions Screening Exception Matrix | Case support reference |
| [KOD-AML-001](../kod/KOD-AML-001_AML_Customer_Screening_Evidence_KOD.md) | AML Customer Screening Evidence KOD | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-AML-001 Potential Sanctions Name Match Resolution. | Chief Compliance Officer |
