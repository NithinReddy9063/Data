...
title: "Partnership Credit Exception Scenario"
...
keywords:
  ...
  - "working capital"
  - "overdraft"
  - "partnership credit exception scenario"
  - "FAQ-Credit-007"
  - "Partnership"
  - "Exception"
related_documents:
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-Credit-007](./FAQ-Credit-007_Partnership_Credit_Exception_Scenario.md) |
| Case Title | Partnership Credit Exception Scenario |
| Domain | Credit |
...
A customer or internal user raises a question linked to partnership credit exception scenario. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Partnership Credit Exception Scenario while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-Credit-001](../policies/POL-Credit-001_Home_Loan_Credit_Assessment_Policy.md) | Home Loan Credit Assessment Policy | Case support reference |
| [SOP-Credit-001](../sops/SOP-Credit-001_Home_Loan_Credit_Assessment_SOP.md) | Home Loan Credit Assessment SOP | Case support reference |
| [EXM-Credit-003](../exception_matrices/EXM-Credit-003_Working_Capital_Exception_Matrix.md) | Working Capital Exception Matrix | Case support reference |
| [KOD-Credit-003](../kod/KOD-Credit-003_Working_Capital_Document_KOD.md) | Working Capital Document KOD | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-Credit-007 Partnership Credit Exception Scenario. | Chief Compliance Officer |
