...
title: "Working Capital Limit Review Scenario"
...
keywords:
  ...
  - "working capital"
  - "overdraft"
  - "working capital limit review scenario"
  - "FAQ-Credit-004"
  - "Working"
  - "Capital"
  - "Limit"
  - "Review"
related_documents:
  - document_id: "POL-Credit-004"
    path: "documents/policies/POL-Credit-004_Working_Capital_Credit_Control_Policy.md"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-Credit-004](./FAQ-Credit-004_Working_Capital_Limit_Review_Scenario.md) |
| Case Title | Working Capital Limit Review Scenario |
| Domain | Credit |
...
A customer or internal user raises a question linked to working capital limit review scenario. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Working Capital Limit Review Scenario while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-Credit-004](../policies/POL-Credit-004_Working_Capital_Credit_Control_Policy.md) | Working Capital Credit Control Policy | Case support reference |
| [SOP-Credit-004](../sops/SOP-Credit-004_Working_Capital_Review_SOP.md) | Working Capital Review SOP | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-Credit-004 Working Capital Limit Review Scenario. | Chief Compliance Officer |
