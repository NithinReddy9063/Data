...
title: "Address Mismatch During Account Opening"
...
keywords:
  ...
  - "verification"
  - "address mismatch during account opening"
  - "FAQ-KYC-001"
  - "Address"
  - "Mismatch"
  - "During"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-KYC-001](./FAQ-KYC-001_Address_Mismatch_During_Account_Opening.md) |
| Case Title | Address Mismatch During Account Opening |
| Domain | KYC |
...
A customer or internal user raises a question linked to address mismatch during account opening. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Address Mismatch During Account Opening while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-KYC-001](../policies/POL-KYC-001_Customer_Identification_and_Verification_Policy.md) | Customer Identification and Verification Policy | Case support reference |
| [SOP-KYC-001](../sops/SOP-KYC-001_Customer_Identity_Verification_SOP.md) | Customer Identity Verification SOP | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-KYC-001 Address Mismatch During Account Opening. | Chief Compliance Officer |
