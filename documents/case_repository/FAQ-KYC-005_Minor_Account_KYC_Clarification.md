...
title: "Minor Account KYC Clarification"
...
keywords:
  ...
  - "verification"
  - "minor account kyc clarification"
  - "FAQ-KYC-005"
  - "Minor"
  - "Account"
related_documents:
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-KYC-005](./FAQ-KYC-005_Minor_Account_KYC_Clarification.md) |
| Case Title | Minor Account KYC Clarification |
| Domain | KYC |
...
A customer or internal user raises a question linked to minor account kyc clarification. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Minor Account KYC Clarification while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-KYC-005](../policies/POL-KYC-005_Risk-Based_Customer_Classification_Policy.md) | Risk-Based Customer Classification Policy | Case support reference |
| [SOP-KYC-005](../sops/SOP-KYC-005_Customer_Risk_Rating_Assignment_SOP.md) | Customer Risk Rating Assignment SOP | Case support reference |
| [EXM-KYC-001](../exception_matrices/EXM-KYC-001_Identity_Document_Exception_Matrix.md) | Identity Document Exception Matrix | Case support reference |
| [KOD-KYC-001](../kod/KOD-KYC-001_Individual_Identity_and_Address_Documents_KOD.md) | Individual Identity and Address Documents KOD | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-KYC-005 Minor Account KYC Clarification. | Chief Compliance Officer |
