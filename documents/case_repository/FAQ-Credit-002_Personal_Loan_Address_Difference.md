...
title: "Personal Loan Address Difference"
...
keywords:
  ...
  - "working capital"
  - "overdraft"
  - "personal loan address difference"
  - "FAQ-Credit-002"
  - "Personal"
  - "Loan"
  - "Address"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-Credit-002](./FAQ-Credit-002_Personal_Loan_Address_Difference.md) |
| Case Title | Personal Loan Address Difference |
| Domain | Credit |
| Owning Department | CRD - Credit Risk |
| Case Status | Approved for Operations Knowledge Assistant use |

## 2 Business Context

This case repository record provides approved guidance for an operations question involving credit assessment, facility review, and lending evidence control. It is designed for controlled retrieval by the internal Operations Knowledge Assistant and must be read together with the linked Policy, SOP, KOD, and Exception Matrix records.

## 3 Customer Scenario

A customer or internal user raises a question linked to personal loan address difference. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Personal Loan Address Difference while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-Credit-002](../policies/POL-Credit-002_Personal_Loan_Credit_Assessment_Policy.md) | Personal Loan Credit Assessment Policy | Case support reference |
| [SOP-Credit-002](../sops/SOP-Credit-002_Personal_Loan_Credit_Assessment_SOP.md) | Personal Loan Credit Assessment SOP | Case support reference |
| [EXM-Credit-002](../exception_matrices/EXM-Credit-002_Business_Loan_Exception_Matrix.md) | Business Loan Exception Matrix | Case support reference |
| [KOD-Credit-002](../kod/KOD-Credit-002_Business_Loan_Document_KOD.md) | Business Loan Document KOD | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-Credit-002 Personal Loan Address Difference. | Chief Compliance Officer |
