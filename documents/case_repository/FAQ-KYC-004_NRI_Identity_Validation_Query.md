...
title: "NRI Identity Validation Query"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-KYC-004](./FAQ-KYC-004_NRI_Identity_Validation_Query.md) |
| Case Title | NRI Identity Validation Query |
| Domain | KYC |
...
A customer or internal user raises a question linked to nri identity validation query. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by NRI Identity Validation Query while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-KYC-004](../policies/POL-KYC-004_Beneficial_Ownership_Identification_Policy.md) | Beneficial Ownership Identification Policy | Case support reference |
| [SOP-KYC-004](../sops/SOP-KYC-004_Beneficial_Ownership_Capture_SOP.md) | Beneficial Ownership Capture SOP | Case support reference |
| [EXM-KYC-004](../exception_matrices/EXM-KYC-004_Periodic_Review_Exception_Matrix.md) | Periodic Review Exception Matrix | Case support reference |
| [KOD-KYC-004](../kod/KOD-KYC-004_KYC_Review_Supporting_Documents_KOD.md) | KYC Review Supporting Documents KOD | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-KYC-004 NRI Identity Validation Query. | Chief Compliance Officer |
