...
title: "Partnership Account Opening Scenario"
...
keywords:
  ...
  - "data quality"
  - "approval routing"
  - "partnership account opening scenario"
  - "FAQ-Customer"
  - "Onboarding-006"
  - "Partnership"
  - "Account"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-Customer Onboarding-006](./FAQ-Customer_Onboarding-006_Partnership_Account_Opening_Scenario.md) |
| Case Title | Partnership Account Opening Scenario |
| Domain | Customer Onboarding |
...
A customer or internal user raises a question linked to partnership account opening scenario. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Partnership Account Opening Scenario while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-Customer Onboarding-006](../policies/POL-Customer_Onboarding-006_Customer_Consent_Capture_Policy.md) | Customer Consent Capture Policy | Case support reference |
| [SOP-Customer Onboarding-006](../sops/SOP-Customer_Onboarding-006_Customer_Consent_Capture_SOP.md) | Customer Consent Capture SOP | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-Customer Onboarding-006 Partnership Account Opening Scenario. | Chief Compliance Officer |
