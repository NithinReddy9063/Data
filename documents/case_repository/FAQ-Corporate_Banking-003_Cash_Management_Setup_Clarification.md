...
title: "Cash Management Setup Clarification"
...
keywords:
  ...
  - "escrow account"
  - "cash management"
  - "cash management setup clarification"
  - "FAQ-Corporate"
  - "Banking-003"
  - "Cash"
  - "Management"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-Corporate Banking-003](./FAQ-Corporate_Banking-003_Cash_Management_Setup_Clarification.md) |
| Case Title | Cash Management Setup Clarification |
| Domain | Corporate Banking |
...
A customer or internal user raises a question linked to cash management setup clarification. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Cash Management Setup Clarification while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-Corporate Banking-003](../policies/POL-Corporate_Banking-003_Cash_Management_Service_Policy.md) | Cash Management Service Policy | Case support reference |
| [SOP-Corporate Banking-003](../sops/SOP-Corporate_Banking-003_Cash_Management_Service_SOP.md) | Cash Management Service SOP | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-Corporate Banking-003 Cash Management Setup Clarification. | Chief Compliance Officer |
