...
title: "Import Finance Invoice Discrepancy"
...
keywords:
  ...
  - "export finance"
  - "import finance"
  - "import finance invoice discrepancy"
  - "FAQ-Trade"
  - "Finance-004"
  - "Import"
  - "Finance"
...
related_documents:
  - document_id: "POL-Trade Finance-004"
    path: "documents/policies/POL-Trade_Finance-004_Import_Finance_Control_Policy.md"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-Trade Finance-004](./FAQ-Trade_Finance-004_Import_Finance_Invoice_Discrepancy.md) |
| Case Title | Import Finance Invoice Discrepancy |
| Domain | Trade Finance |
...
A customer or internal user raises a question linked to import finance invoice discrepancy. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Import Finance Invoice Discrepancy while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-Trade Finance-004](../policies/POL-Trade_Finance-004_Import_Finance_Control_Policy.md) | Import Finance Control Policy | Case support reference |
| [SOP-Trade Finance-004](../sops/SOP-Trade_Finance-004_Import_Finance_Processing_SOP.md) | Import Finance Processing SOP | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-Trade Finance-004 Import Finance Invoice Discrepancy. | Chief Compliance Officer |
