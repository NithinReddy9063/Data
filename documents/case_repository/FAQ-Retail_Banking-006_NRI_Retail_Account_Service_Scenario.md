...
title: "NRI Retail Account Service Scenario"
...
keywords:
  ...
  - "salary account"
  - "deposit servicing"
  - "nri retail account service scenario"
  - "FAQ-Retail"
  - "Banking-006"
  - "NRI"
  - "Retail"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-Retail Banking-006](./FAQ-Retail_Banking-006_NRI_Retail_Account_Service_Scenario.md) |
| Case Title | NRI Retail Account Service Scenario |
| Domain | Retail Banking |
...
A customer or internal user raises a question linked to nri retail account service scenario. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by NRI Retail Account Service Scenario while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-Retail Banking-006 NRI Retail Account Service Scenario. | Chief Compliance Officer |
