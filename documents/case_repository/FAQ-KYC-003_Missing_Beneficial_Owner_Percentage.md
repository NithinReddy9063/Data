...
title: "Missing Beneficial Owner Percentage"
...
keywords:
  ...
  - "verification"
  - "missing beneficial owner percentage"
  - "FAQ-KYC-003"
  - "Missing"
  - "Beneficial"
  - "Owner"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-KYC-003](./FAQ-KYC-003_Missing_Beneficial_Owner_Percentage.md) |
| Case Title | Missing Beneficial Owner Percentage |
| Domain | KYC |
...
A customer or internal user raises a question linked to missing beneficial owner percentage. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Missing Beneficial Owner Percentage while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-KYC-003](../policies/POL-KYC-003_Enhanced_Due_Diligence_Policy.md) | Enhanced Due Diligence Policy | Case support reference |
| [SOP-KYC-003](../sops/SOP-KYC-003_Enhanced_Due_Diligence_Review_SOP.md) | Enhanced Due Diligence Review SOP | Case support reference |
| [EXM-KYC-003](../exception_matrices/EXM-KYC-003_Beneficial_Ownership_Exception_Matrix.md) | Beneficial Ownership Exception Matrix | Case support reference |
| [KOD-KYC-003](../kod/KOD-KYC-003_Beneficial_Ownership_Documents_KOD.md) | Beneficial Ownership Documents KOD | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-KYC-003 Missing Beneficial Owner Percentage. | Chief Compliance Officer |
