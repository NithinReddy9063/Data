...
title: "Missing Consent Capture Scenario"
...
keywords:
  ...
  - "data quality"
  - "approval routing"
  - "missing consent capture scenario"
  - "FAQ-Customer"
  - "Onboarding-002"
  - "Missing"
  - "Capture"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-Customer Onboarding-002](./FAQ-Customer_Onboarding-002_Missing_Consent_Capture_Scenario.md) |
| Case Title | Missing Consent Capture Scenario |
| Domain | Customer Onboarding |
...
A customer or internal user raises a question linked to missing consent capture scenario. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Missing Consent Capture Scenario while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-Customer Onboarding-002](../policies/POL-Customer_Onboarding-002_Customer_Onboarding_Documentation_Policy.md) | Customer Onboarding Documentation Policy | Case support reference |
| [SOP-Customer Onboarding-002](../sops/SOP-Customer_Onboarding-002_Onboarding_Document_Collection_SOP.md) | Onboarding Document Collection SOP | Case support reference |
| [EXM-Customer Onboarding-002](../exception_matrices/EXM-Customer_Onboarding-002_Consent_Capture_Exception_Matrix.md) | Consent Capture Exception Matrix | Case support reference |
| [KOD-Customer Onboarding-002](../kod/KOD-Customer_Onboarding-002_Customer_Consent_Document_KOD.md) | Customer Consent Document KOD | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-Customer Onboarding-002 Missing Consent Capture Scenario. | Chief Compliance Officer |
