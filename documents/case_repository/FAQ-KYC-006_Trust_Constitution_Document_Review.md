...
title: "Trust Constitution Document Review"
...
keywords:
  ...
  - "verification"
  - "trust constitution document review"
  - "FAQ-KYC-006"
  - "Trust"
  - "Constitution"
  - "Review"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-KYC-006](./FAQ-KYC-006_Trust_Constitution_Document_Review.md) |
| Case Title | Trust Constitution Document Review |
| Domain | KYC |
| Owning Department | CMP - Compliance |
| Case Status | Approved for Operations Knowledge Assistant use |

## 2 Business Context

This case repository record provides approved guidance for an operations question involving customer identification, verification, and due diligence. It is designed for controlled retrieval by the internal Operations Knowledge Assistant and must be read together with the linked Policy, SOP, KOD, and Exception Matrix records.

## 3 Customer Scenario

A customer or internal user raises a question linked to trust constitution document review. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Trust Constitution Document Review while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-KYC-006](../policies/POL-KYC-006_Periodic_KYC_Review_Policy.md) | Periodic KYC Review Policy | Case support reference |
| [SOP-KYC-006](../sops/SOP-KYC-006_Periodic_KYC_Refresh_SOP.md) | Periodic KYC Refresh SOP | Case support reference |
| [EXM-KYC-002](../exception_matrices/EXM-KYC-002_Address_Proof_Exception_Matrix.md) | Address Proof Exception Matrix | Case support reference |
| [KOD-KYC-002](../kod/KOD-KYC-002_Non-Individual_Constitution_Documents_KOD.md) | Non-Individual Constitution Documents KOD | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-KYC-006 Trust Constitution Document Review. | Chief Compliance Officer |
