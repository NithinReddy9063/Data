...
title: "Sole Proprietor Onboarding Query"
...
keywords:
  ...
  - "data quality"
  - "approval routing"
  - "sole proprietor onboarding query"
  - "FAQ-Customer"
  - "Onboarding-005"
  - "Sole"
  - "Proprietor"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-Customer Onboarding-005](./FAQ-Customer_Onboarding-005_Sole_Proprietor_Onboarding_Query.md) |
| Case Title | Sole Proprietor Onboarding Query |
| Domain | Customer Onboarding |
...
A customer or internal user raises a question linked to sole proprietor onboarding query. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Sole Proprietor Onboarding Query while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-Customer Onboarding-005](../policies/POL-Customer_Onboarding-005_Onboarding_Data_Quality_Policy.md) | Onboarding Data Quality Policy | Case support reference |
| [SOP-Customer Onboarding-005](../sops/SOP-Customer_Onboarding-005_Onboarding_Data_Quality_Review_SOP.md) | Onboarding Data Quality Review SOP | Case support reference |
| [EXM-Customer Onboarding-001](../exception_matrices/EXM-Customer_Onboarding-001_Account_Opening_Exception_Matrix.md) | Account Opening Exception Matrix | Case support reference |
| [KOD-Customer Onboarding-001](../kod/KOD-Customer_Onboarding-001_Account_Opening_Form_KOD.md) | Account Opening Form KOD | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-Customer Onboarding-005 Sole Proprietor Onboarding Query. | Chief Compliance Officer |
