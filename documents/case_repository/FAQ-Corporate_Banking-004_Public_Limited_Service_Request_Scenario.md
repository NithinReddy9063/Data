...
title: "Public Limited Service Request Scenario"
...
keywords:
  ...
  - "escrow account"
  - "cash management"
  - "public limited service request scenario"
  - "FAQ-Corporate"
  - "Banking-004"
  - "Public"
  - "Limited"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-Corporate Banking-004](./FAQ-Corporate_Banking-004_Public_Limited_Service_Request_Scenario.md) |
| Case Title | Public Limited Service Request Scenario |
| Domain | Corporate Banking |
...
A customer or internal user raises a question linked to public limited service request scenario. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Public Limited Service Request Scenario while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-Corporate Banking-004](../policies/POL-Corporate_Banking-004_Corporate_Customer_Maintenance_Policy.md) | Corporate Customer Maintenance Policy | Case support reference |
| [SOP-Corporate Banking-004](../sops/SOP-Corporate_Banking-004_Corporate_Customer_Maintenance_SOP.md) | Corporate Customer Maintenance SOP | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-Corporate Banking-004 Public Limited Service Request Scenario. | Chief Compliance Officer |
