...
title: "Business Current Account Payment Query"
...
keywords:
  ...
  - "SWIFT"
  - "ACH"
  - "business current account payment query"
  - "FAQ-Payments-007"
  - "Business"
  - "Current"
  - "Account"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-Payments-007](./FAQ-Payments-007_Business_Current_Account_Payment_Query.md) |
| Case Title | Business Current Account Payment Query |
| Domain | Payments |
...
A customer or internal user raises a question linked to business current account payment query. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Business Current Account Payment Query while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-Payments-001](../policies/POL-Payments-001_NEFT_Processing_Policy.md) | NEFT Processing Policy | Case support reference |
| [SOP-Payments-001](../sops/SOP-Payments-001_NEFT_Payment_Processing_SOP.md) | NEFT Payment Processing SOP | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-Payments-007 Business Current Account Payment Query. | Chief Compliance Officer |
