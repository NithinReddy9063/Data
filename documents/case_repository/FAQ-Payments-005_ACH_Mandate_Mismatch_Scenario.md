...
title: "ACH Mandate Mismatch Scenario"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-Payments-005](./FAQ-Payments-005_ACH_Mandate_Mismatch_Scenario.md) |
| Case Title | ACH Mandate Mismatch Scenario |
| Domain | Payments |
...
How should ACB handle the customer or operational question described by ACH Mandate Mismatch Scenario while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-Payments-005](../policies/POL-Payments-005_ACH_Processing_Policy.md) | ACH Processing Policy | Case support reference |
| [SOP-Payments-005](../sops/SOP-Payments-005_ACH_Payment_Processing_SOP.md) | ACH Payment Processing SOP | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-Payments-005 ACH Mandate Mismatch Scenario. | Chief Compliance Officer |
