---
document_id: "FAQ-Credit-008"
title: "Trust Credit Eligibility Question"
...
keywords:
  ...
  - "working capital"
  - "overdraft"
  - "trust credit eligibility question"
  - "FAQ-Credit-008"
  - "Trust"
  - "Eligibility"
  - "Question"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-Credit-008](./FAQ-Credit-008_Trust_Credit_Eligibility_Question.md) |
| Case Title | Trust Credit Eligibility Question |
| Domain | Credit |
...
A customer or internal user raises a question linked to trust credit eligibility question. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Trust Credit Eligibility Question while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| [EXM-Credit-004](../exception_matrices/EXM-Credit-004_Overdraft_Exception_Matrix.md) | Overdraft Exception Matrix | Case support reference |
| [KOD-Credit-004](../kod/KOD-Credit-004_Overdraft_Document_KOD.md) | Overdraft Document KOD | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-Credit-008 Trust Credit Eligibility Question. | Chief Compliance Officer |
