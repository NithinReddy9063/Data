...
title: "Trade Transaction Review SLA Query"
...
keywords:
  ...
  - "export finance"
  - "import finance"
  - "trade transaction review sla query"
  - "FAQ-Trade"
  - "Finance-006"
  - "Trade"
  - "Transaction"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-Trade Finance-006](./FAQ-Trade_Finance-006_Trade_Transaction_Review_SLA_Query.md) |
| Case Title | Trade Transaction Review SLA Query |
| Domain | Trade Finance |
...
A customer or internal user raises a question linked to trade transaction review sla query. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Trade Transaction Review SLA Query while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-Trade Finance-006](../policies/POL-Trade_Finance-006_Trade_Transaction_Review_Policy.md) | Trade Transaction Review Policy | Case support reference |
| [SOP-Trade Finance-006](../sops/SOP-Trade_Finance-006_Trade_Transaction_Review_SOP.md) | Trade Transaction Review SOP | Case support reference |
| [EXM-Trade Finance-002](../exception_matrices/EXM-Trade_Finance-002_Bank_Guarantee_Exception_Matrix.md) | Bank Guarantee Exception Matrix | Case support reference |
| [KOD-Trade Finance-002](../kod/KOD-Trade_Finance-002_Bank_Guarantee_Document_KOD.md) | Bank Guarantee Document KOD | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-Trade Finance-006 Trade Transaction Review SLA Query. | Chief Compliance Officer |
