...
title: "Business Current Account Signatory Update"
...
keywords:
  ...
  - "escrow account"
  - "cash management"
  - "business current account signatory update"
  - "FAQ-Corporate"
  - "Banking-001"
  - "Business"
  - "Current"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-Corporate Banking-001](./FAQ-Corporate_Banking-001_Business_Current_Account_Signatory_Update.md) |
| Case Title | Business Current Account Signatory Update |
| Domain | Corporate Banking |
| Owning Department | COR - Corporate Banking |
| Case Status | Approved for Operations Knowledge Assistant use |

## 2 Business Context

This case repository record provides approved guidance for an operations question involving corporate account servicing, escrow control, and cash management support. It is designed for controlled retrieval by the internal Operations Knowledge Assistant and must be read together with the linked Policy, SOP, KOD, and Exception Matrix records.

## 3 Customer Scenario

A customer or internal user raises a question linked to business current account signatory update. The Operations Officer must determine whether the case can proceed under standard handling, requires remediation, or must be escalated because the evidence, approval, risk level, or service instruction is incomplete or inconsistent.
...
How should ACB handle the customer or operational question described by Business Current Account Signatory Update while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-Corporate Banking-001](../policies/POL-Corporate_Banking-001_Business_Current_Account_Servicing_Policy.md) | Business Current Account Servicing Policy | Case support reference |
| [SOP-Corporate Banking-001](../sops/SOP-Corporate_Banking-001_Business_Current_Account_Service_SOP.md) | Business Current Account Service SOP | Case support reference |
| [EXM-Corporate Banking-001](../exception_matrices/EXM-Corporate_Banking-001_Business_Current_Account_Exception_Matrix.md) | Business Current Account Exception Matrix | Case support reference |
| [KOD-Corporate Banking-001](../kod/KOD-Corporate_Banking-001_Business_Current_Account_Documents_KOD.md) | Business Current Account Documents KOD | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-Corporate Banking-001 Business Current Account Signatory Update. | Chief Compliance Officer |
