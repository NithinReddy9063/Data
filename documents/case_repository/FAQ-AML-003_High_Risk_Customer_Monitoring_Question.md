...
title: "High Risk Customer Monitoring Question"
...
related_documents:
  ...
  - document_id: "SOP-AML-003"
    path: "documents/sops/SOP-AML-003_Suspicious_Activity_Assessment_SOP.md"
...
| Case Field | Value |
| --- | --- |
| Case ID | [FAQ-AML-003](./FAQ-AML-003_High_Risk_Customer_Monitoring_Question.md) |
| Case Title | High Risk Customer Monitoring Question |
| Domain | AML |
...
How should ACB handle the customer or operational question described by High Risk Customer Monitoring Question while preserving the approved document structure, product catalogue, customer type rules, approval hierarchy, risk classification, and related document controls?
...
| --- | --- | --- |
| [POL-AML-003](../policies/POL-AML-003_Suspicious_Activity_Review_Policy.md) | Suspicious Activity Review Policy | Case support reference |
| [SOP-AML-003](../sops/SOP-AML-003_Suspicious_Activity_Assessment_SOP.md) | Suspicious Activity Assessment SOP | Case support reference |
| [EXM-AML-003](../exception_matrices/EXM-AML-003_Suspicious_Activity_Escalation_Exception_Matrix.md) | Suspicious Activity Escalation Exception Matrix | Case support reference |
| [KOD-AML-003](../kod/KOD-AML-003_Suspicious_Activity_Case_Documents_KOD.md) | Suspicious Activity Case Documents KOD | Case support reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for FAQ-AML-003 High Risk Customer Monitoring Question. | Chief Compliance Officer |
