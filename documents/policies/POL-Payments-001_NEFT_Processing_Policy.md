...
related_documents:
  ...
  - document_id: "SOP-Payments-003"
    path: "documents/sops/SOP-Payments-003_IMPS_and_UPI_Payment_Processing_SOP.md"
...
The policy supports the Operations Knowledge Assistant by providing approved decision logic, accountable roles, cross-reference points, and deployment-ready guidance for the document record POL-Payments-001.
...
| --- | --- | --- | --- | --- |
| POL-Payments-001-CTRL-01 | Confirm mandatory evidence is present and linked to the customer or case record | Operations Officer | Per request | Completed checklist and evidence record |
| POL-Payments-001-CTRL-02 | Confirm discrepancies and exceptions are reviewed before completion | Operations Manager | Per exception | Exception decision and reviewer rationale |
| POL-Payments-001-CTRL-03 | Confirm High and Critical risk matters receive required escalation | Senior Compliance Officer | Per escalated case | Enhanced review note and approval trail |
| POL-Payments-001-CTRL-04 | Confirm records are retained and retrievable for audit | Department Head | Quarterly | Sample review results and remediation tracker |
...
| [SOP-Payments-002](../sops/SOP-Payments-002_RTGS_Payment_Processing_SOP.md) | RTGS Payment Processing SOP | Mandatory policy cross-reference |
| [SOP-Payments-003](../sops/SOP-Payments-003_IMPS_and_UPI_Payment_Processing_SOP.md) | IMPS and UPI Payment Processing SOP | Mandatory policy cross-reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for POL-Payments-001 NEFT Processing Policy. | Chief Compliance Officer |
