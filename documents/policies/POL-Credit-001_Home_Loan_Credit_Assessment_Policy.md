...
title: "Home Loan Credit Assessment Policy"
...
keywords:
  ...
  - "working capital"
  - "overdraft"
  - "home loan credit assessment policy"
  - "POL-Credit-001"
  - "Home"
  - "Loan"
  - "Assessment"
related_documents:
  - document_id: "SOP-Credit-001"
    path: "documents/sops/SOP-Credit-001_Home_Loan_Credit_Assessment_SOP.md"
  ...
  - document_id: "EXM-Credit-001"
    path: "documents/exception_matrices/EXM-Credit-001_Retail_Loan_Exception_Matrix.md"
...
The policy supports the Operations Knowledge Assistant by providing approved decision logic, accountable roles, cross-reference points, and deployment-ready guidance for the document record POL-Credit-001.
...
| --- | --- | --- | --- | --- |
| POL-Credit-001-CTRL-01 | Confirm mandatory evidence is present and linked to the customer or case record | Operations Officer | Per request | Completed checklist and evidence record |
| POL-Credit-001-CTRL-02 | Confirm discrepancies and exceptions are reviewed before completion | Operations Manager | Per exception | Exception decision and reviewer rationale |
| POL-Credit-001-CTRL-03 | Confirm High and Critical risk matters receive required escalation | Senior Compliance Officer | Per escalated case | Enhanced review note and approval trail |
| POL-Credit-001-CTRL-04 | Confirm records are retained and retrievable for audit | Department Head | Quarterly | Sample review results and remediation tracker |

## 10 Related Documents

| Document ID | Title | Relationship |
| --- | --- | --- |
| [SOP-Credit-001](../sops/SOP-Credit-001_Home_Loan_Credit_Assessment_SOP.md) | Home Loan Credit Assessment SOP | Mandatory policy cross-reference |
...
| [KOD-Credit-001](../kod/KOD-Credit-001_Retail_Loan_Document_KOD.md) | Retail Loan Document KOD | Mandatory policy cross-reference |
...
| [EXM-Credit-001](../exception_matrices/EXM-Credit-001_Retail_Loan_Exception_Matrix.md) | Retail Loan Exception Matrix | Mandatory policy cross-reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for POL-Credit-001 Home Loan Credit Assessment Policy. | Chief Compliance Officer |
