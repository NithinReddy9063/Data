...
title: "Customer Onboarding Documentation Policy"
...
keywords:
  ...
  - "data quality"
  - "approval routing"
  - "customer onboarding documentation policy"
  - "POL-Customer"
  - "Onboarding-002"
  - "Customer"
  - "Onboarding"
...
related_documents:
  - document_id: "SOP-Customer Onboarding-002"
    path: "documents/sops/SOP-Customer_Onboarding-002_Onboarding_Document_Collection_SOP.md"
  - document_id: "SOP-Customer Onboarding-003"
    path: "documents/sops/SOP-Customer_Onboarding-003_Onboarding_Approval_Routing_SOP.md"
  - document_id: "SOP-Customer Onboarding-004"
    path: "documents/sops/SOP-Customer_Onboarding-004_High_Risk_Onboarding_Review_SOP.md"
  ...
  - document_id: "EXM-Customer Onboarding-002"
    path: "documents/exception_matrices/EXM-Customer_Onboarding-002_Consent_Capture_Exception_Matrix.md"
  - document_id: "EXM-Customer Onboarding-003"
    path: "documents/exception_matrices/EXM-Customer_Onboarding-003_Onboarding_Data_Exception_Matrix.md"
  - document_id: "EXM-Customer Onboarding-004"
    path: "documents/exception_matrices/EXM-Customer_Onboarding-004_High_Risk_Onboarding_Exception_Matrix.md"
supersedes: null
synthetic: true
---
# Customer Onboarding Documentation Policy
...
This policy defines the mandatory governance, control, approval, and evidence requirements for customer account opening, approval routing, and onboarding data control within APEX Commercial Bank. It establishes a consistent enterprise standard for Customer Onboarding activities so that customer decisions, operational actions, exception handling, and record keeping are performed in a controlled and auditable manner.

The policy supports the Operations Knowledge Assistant by providing approved decision logic, accountable roles, cross-reference points, and deployment-ready guidance for the document record POL-Customer Onboarding-002.

## 2 Scope

This policy applies to the department OPS - Banking Operations, the business unit Operations, all applicable products and customer types defined in the Document Control metadata, and all ACB personnel performing or approving Customer Onboarding activity.
...
1. ACB must perform customer account opening, approval routing, and onboarding data control in accordance with this policy and the related documents listed in the Related Documents section.
...
| --- | --- | --- | --- |
| Standard review request received | Standard Account Opening - 2 Business Days | Operations Officer records decision or blocker | SLA cannot be met because evidence or approval is incomplete |
...
| --- | --- | --- | --- | --- |
| POL-Customer Onboarding-002-CTRL-01 | Confirm mandatory evidence is present and linked to the customer or case record | Operations Officer | Per request | Completed checklist and evidence record |
| POL-Customer Onboarding-002-CTRL-02 | Confirm discrepancies and exceptions are reviewed before completion | Operations Manager | Per exception | Exception decision and reviewer rationale |
| POL-Customer Onboarding-002-CTRL-03 | Confirm High and Critical risk matters receive required escalation | Senior Compliance Officer | Per escalated case | Enhanced review note and approval trail |
| POL-Customer Onboarding-002-CTRL-04 | Confirm records are retained and retrievable for audit | Department Head | Quarterly | Sample review results and remediation tracker |

## 10 Related Documents

| Document ID | Title | Relationship |
| --- | --- | --- |
| [SOP-Customer Onboarding-002](../sops/SOP-Customer_Onboarding-002_Onboarding_Document_Collection_SOP.md) | Onboarding Document Collection SOP | Mandatory policy cross-reference |
| [SOP-Customer Onboarding-003](../sops/SOP-Customer_Onboarding-003_Onboarding_Approval_Routing_SOP.md) | Onboarding Approval Routing SOP | Mandatory policy cross-reference |
| [SOP-Customer Onboarding-004](../sops/SOP-Customer_Onboarding-004_High_Risk_Onboarding_Review_SOP.md) | High Risk Onboarding Review SOP | Mandatory policy cross-reference |
| [KOD-Customer Onboarding-002](../kod/KOD-Customer_Onboarding-002_Customer_Consent_Document_KOD.md) | Customer Consent Document KOD | Mandatory policy cross-reference |
| [KOD-Customer Onboarding-003](../kod/KOD-Customer_Onboarding-003_Onboarding_Supporting_Document_KOD.md) | Onboarding Supporting Document KOD | Mandatory policy cross-reference |
| [KOD-Customer Onboarding-004](../kod/KOD-Customer_Onboarding-004_High_Risk_Onboarding_Evidence_KOD.md) | High Risk Onboarding Evidence KOD | Mandatory policy cross-reference |
| [EXM-Customer Onboarding-002](../exception_matrices/EXM-Customer_Onboarding-002_Consent_Capture_Exception_Matrix.md) | Consent Capture Exception Matrix | Mandatory policy cross-reference |
| [EXM-Customer Onboarding-003](../exception_matrices/EXM-Customer_Onboarding-003_Onboarding_Data_Exception_Matrix.md) | Onboarding Data Exception Matrix | Mandatory policy cross-reference |
| [EXM-Customer Onboarding-004](../exception_matrices/EXM-Customer_Onboarding-004_High_Risk_Onboarding_Exception_Matrix.md) | High Risk Onboarding Exception Matrix | Mandatory policy cross-reference |

## 11 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for POL-Customer Onboarding-002 Customer Onboarding Documentation Policy. | Chief Compliance Officer |
