...
title: "Salary Account Servicing Policy"
...
keywords:
  ...
  - "salary account"
  - "deposit servicing"
  - "salary account servicing policy"
  - "POL-Retail"
  - "Banking-003"
  - "Salary"
  - "Account"
...
The policy supports the Operations Knowledge Assistant by providing approved decision logic, accountable roles, cross-reference points, and deployment-ready guidance for the document record POL-Retail Banking-003.
...
| --- | --- | --- | --- | --- |
| POL-Retail Banking-003-CTRL-01 | Confirm mandatory evidence is present and linked to the customer or case record | Operations Officer | Per request | Completed checklist and evidence record |
| POL-Retail Banking-003-CTRL-02 | Confirm discrepancies and exceptions are reviewed before completion | Operations Manager | Per exception | Exception decision and reviewer rationale |
| POL-Retail Banking-003-CTRL-03 | Confirm High and Critical risk matters receive required escalation | Senior Compliance Officer | Per escalated case | Enhanced review note and approval trail |
| POL-Retail Banking-003-CTRL-04 | Confirm records are retained and retrievable for audit | Department Head | Quarterly | Sample review results and remediation tracker |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for POL-Retail Banking-003 Salary Account Servicing Policy. | Chief Compliance Officer |
