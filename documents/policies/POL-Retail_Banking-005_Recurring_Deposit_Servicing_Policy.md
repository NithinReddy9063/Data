...
title: "Recurring Deposit Servicing Policy"
...
keywords:
  ...
  - "salary account"
  - "deposit servicing"
  - "recurring deposit servicing policy"
  - "POL-Retail"
  - "Banking-005"
  - "Recurring"
  - "Deposit"
...
related_documents:
  - document_id: "SOP-Retail Banking-005"
    path: "documents/sops/SOP-Retail_Banking-005_Recurring_Deposit_Service_Request_SOP.md"
  - document_id: "SOP-Retail Banking-001"
    path: "documents/sops/SOP-Retail_Banking-001_Savings_Account_Service_Request_SOP.md"
  - document_id: "SOP-Retail Banking-002"
    path: "documents/sops/SOP-Retail_Banking-002_Current_Account_Service_Request_SOP.md"
  ...
  - document_id: "EXM-Retail Banking-002"
    path: "documents/exception_matrices/EXM-Retail_Banking-002_Fixed_Deposit_Exception_Matrix.md"
  - document_id: "EXM-Retail Banking-003"
    path: "documents/exception_matrices/EXM-Retail_Banking-003_Recurring_Deposit_Exception_Matrix.md"
  - document_id: "EXM-Retail Banking-001"
    path: "documents/exception_matrices/EXM-Retail_Banking-001_Retail_Account_Service_Exception_Matrix.md"
supersedes: null
synthetic: true
---
# Recurring Deposit Servicing Policy
...
This policy defines the mandatory governance, control, approval, and evidence requirements for retail account servicing, deposit handling, and customer maintenance within APEX Commercial Bank. It establishes a consistent enterprise standard for Retail Banking activities so that customer decisions, operational actions, exception handling, and record keeping are performed in a controlled and auditable manner.

The policy supports the Operations Knowledge Assistant by providing approved decision logic, accountable roles, cross-reference points, and deployment-ready guidance for the document record POL-Retail Banking-005.

## 2 Scope

This policy applies to the department RET - Retail Banking, the business unit Retail Banking, all applicable products and customer types defined in the Document Control metadata, and all ACB personnel performing or approving Retail Banking activity.
...
1. ACB must perform retail account servicing, deposit handling, and customer maintenance in accordance with this policy and the related documents listed in the Related Documents section.
...
| --- | --- | --- | --- |
| Standard review request received | Complaint Resolution - 3 Business Days | Operations Officer records decision or blocker | SLA cannot be met because evidence or approval is incomplete |
...
| --- | --- | --- | --- | --- |
| POL-Retail Banking-005-CTRL-01 | Confirm mandatory evidence is present and linked to the customer or case record | Operations Officer | Per request | Completed checklist and evidence record |
| POL-Retail Banking-005-CTRL-02 | Confirm discrepancies and exceptions are reviewed before completion | Operations Manager | Per exception | Exception decision and reviewer rationale |
| POL-Retail Banking-005-CTRL-03 | Confirm High and Critical risk matters receive required escalation | Senior Compliance Officer | Per escalated case | Enhanced review note and approval trail |
| POL-Retail Banking-005-CTRL-04 | Confirm records are retained and retrievable for audit | Department Head | Quarterly | Sample review results and remediation tracker |

## 10 Related Documents

| Document ID | Title | Relationship |
| --- | --- | --- |
| [SOP-Retail Banking-005](../sops/SOP-Retail_Banking-005_Recurring_Deposit_Service_Request_SOP.md) | Recurring Deposit Service Request SOP | Mandatory policy cross-reference |
| [SOP-Retail Banking-001](../sops/SOP-Retail_Banking-001_Savings_Account_Service_Request_SOP.md) | Savings Account Service Request SOP | Mandatory policy cross-reference |
| [SOP-Retail Banking-002](../sops/SOP-Retail_Banking-002_Current_Account_Service_Request_SOP.md) | Current Account Service Request SOP | Mandatory policy cross-reference |
| [KOD-Retail Banking-002](../kod/KOD-Retail_Banking-002_Fixed_Deposit_Documents_KOD.md) | Fixed Deposit Documents KOD | Mandatory policy cross-reference |
| [KOD-Retail Banking-003](../kod/KOD-Retail_Banking-003_Recurring_Deposit_Documents_KOD.md) | Recurring Deposit Documents KOD | Mandatory policy cross-reference |
| [KOD-Retail Banking-001](../kod/KOD-Retail_Banking-001_Retail_Account_Service_Documents_KOD.md) | Retail Account Service Documents KOD | Mandatory policy cross-reference |
| [EXM-Retail Banking-002](../exception_matrices/EXM-Retail_Banking-002_Fixed_Deposit_Exception_Matrix.md) | Fixed Deposit Exception Matrix | Mandatory policy cross-reference |
| [EXM-Retail Banking-003](../exception_matrices/EXM-Retail_Banking-003_Recurring_Deposit_Exception_Matrix.md) | Recurring Deposit Exception Matrix | Mandatory policy cross-reference |
| [EXM-Retail Banking-001](../exception_matrices/EXM-Retail_Banking-001_Retail_Account_Service_Exception_Matrix.md) | Retail Account Service Exception Matrix | Mandatory policy cross-reference |

## 11 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for POL-Retail Banking-005 Recurring Deposit Servicing Policy. | Chief Compliance Officer |
