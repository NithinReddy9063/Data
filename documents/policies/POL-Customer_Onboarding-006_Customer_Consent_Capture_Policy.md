...
title: "Customer Consent Capture Policy"
...
keywords:
  ...
  - "data quality"
  - "approval routing"
  - "customer consent capture policy"
  - "POL-Customer"
  - "Onboarding-006"
  - "Customer"
  - "Capture"
related_documents:
  - document_id: "SOP-Customer Onboarding-006"
    path: "documents/sops/SOP-Customer_Onboarding-006_Customer_Consent_Capture_SOP.md"
...
The policy supports the Operations Knowledge Assistant by providing approved decision logic, accountable roles, cross-reference points, and deployment-ready guidance for the document record POL-Customer Onboarding-006.
...
| --- | --- | --- | --- | --- |
| POL-Customer Onboarding-006-CTRL-01 | Confirm mandatory evidence is present and linked to the customer or case record | Operations Officer | Per request | Completed checklist and evidence record |
| POL-Customer Onboarding-006-CTRL-02 | Confirm discrepancies and exceptions are reviewed before completion | Operations Manager | Per exception | Exception decision and reviewer rationale |
| POL-Customer Onboarding-006-CTRL-03 | Confirm High and Critical risk matters receive required escalation | Senior Compliance Officer | Per escalated case | Enhanced review note and approval trail |
| POL-Customer Onboarding-006-CTRL-04 | Confirm records are retained and retrievable for audit | Department Head | Quarterly | Sample review results and remediation tracker |

## 10 Related Documents

| Document ID | Title | Relationship |
| --- | --- | --- |
| [SOP-Customer Onboarding-006](../sops/SOP-Customer_Onboarding-006_Customer_Consent_Capture_SOP.md) | Customer Consent Capture SOP | Mandatory policy cross-reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for POL-Customer Onboarding-006 Customer Consent Capture Policy. | Chief Compliance Officer |
