...
title: "Beneficial Ownership Identification Policy"
...
related_documents:
  ...
  - document_id: "SOP-KYC-005"
    path: "documents/sops/SOP-KYC-005_Customer_Risk_Rating_Assignment_SOP.md"
  - document_id: "SOP-KYC-006"
    path: "documents/sops/SOP-KYC-006_Periodic_KYC_Refresh_SOP.md"
...
The policy supports the Operations Knowledge Assistant by providing approved decision logic, accountable roles, cross-reference points, and deployment-ready guidance for the document record POL-KYC-004.
...
| --- | --- | --- | --- | --- |
| POL-KYC-004-CTRL-01 | Confirm mandatory evidence is present and linked to the customer or case record | Operations Officer | Per request | Completed checklist and evidence record |
| POL-KYC-004-CTRL-02 | Confirm discrepancies and exceptions are reviewed before completion | Operations Manager | Per exception | Exception decision and reviewer rationale |
| POL-KYC-004-CTRL-03 | Confirm High and Critical risk matters receive required escalation | Senior Compliance Officer | Per escalated case | Enhanced review note and approval trail |
| POL-KYC-004-CTRL-04 | Confirm records are retained and retrievable for audit | Department Head | Quarterly | Sample review results and remediation tracker |

## 10 Related Documents

| Document ID | Title | Relationship |
| --- | --- | --- |
| [SOP-KYC-004](../sops/SOP-KYC-004_Beneficial_Ownership_Capture_SOP.md) | Beneficial Ownership Capture SOP | Mandatory policy cross-reference |
| [SOP-KYC-005](../sops/SOP-KYC-005_Customer_Risk_Rating_Assignment_SOP.md) | Customer Risk Rating Assignment SOP | Mandatory policy cross-reference |
| [SOP-KYC-006](../sops/SOP-KYC-006_Periodic_KYC_Refresh_SOP.md) | Periodic KYC Refresh SOP | Mandatory policy cross-reference |
...
| [KOD-KYC-002](../kod/KOD-KYC-002_Non-Individual_Constitution_Documents_KOD.md) | Non-Individual Constitution Documents KOD | Mandatory policy cross-reference |
...
| [EXM-KYC-002](../exception_matrices/EXM-KYC-002_Address_Proof_Exception_Matrix.md) | Address Proof Exception Matrix | Mandatory policy cross-reference |

## 11 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for POL-KYC-004 Beneficial Ownership Identification Policy. | Chief Compliance Officer |
