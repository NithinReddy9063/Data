...
keywords:
  ...
  - "SWIFT"
  - "ACH"
  - "ach processing policy"
  - "POL-Payments-005"
  - "Processing"
related_documents:
  - document_id: "SOP-Payments-005"
    path: "documents/sops/SOP-Payments-005_ACH_Payment_Processing_SOP.md"
  - document_id: "SOP-Payments-006"
    path: "documents/sops/SOP-Payments-006_Payment_Exception_Handling_SOP.md"
  - document_id: "SOP-Payments-001"
    path: "documents/sops/SOP-Payments-001_NEFT_Payment_Processing_SOP.md"
  ...
  - document_id: "EXM-Payments-001"
    path: "documents/exception_matrices/EXM-Payments-001_Domestic_Payment_Exception_Matrix.md"
  - document_id: "EXM-Payments-002"
    path: "documents/exception_matrices/EXM-Payments-002_SWIFT_Payment_Exception_Matrix.md"
  - document_id: "EXM-Payments-003"
    path: "documents/exception_matrices/EXM-Payments-003_ACH_Payment_Exception_Matrix.md"
supersedes: null
synthetic: true
---
# ACH Processing Policy
...
This policy defines the mandatory governance, control, approval, and evidence requirements for payment instruction validation, processing, repair, and exception handling within APEX Commercial Bank. It establishes a consistent enterprise standard for Payments activities so that customer decisions, operational actions, exception handling, and record keeping are performed in a controlled and auditable manner.

The policy supports the Operations Knowledge Assistant by providing approved decision logic, accountable roles, cross-reference points, and deployment-ready guidance for the document record POL-Payments-005.

## 2 Scope

This policy applies to the department PAY - Payments, the business unit Corporate Banking, all applicable products and customer types defined in the Document Control metadata, and all ACB personnel performing or approving Payments activity.
...
1. ACB must perform payment instruction validation, processing, repair, and exception handling in accordance with this policy and the related documents listed in the Related Documents section.
...
| --- | --- | --- | --- | --- |
| POL-Payments-005-CTRL-01 | Confirm mandatory evidence is present and linked to the customer or case record | Operations Officer | Per request | Completed checklist and evidence record |
| POL-Payments-005-CTRL-02 | Confirm discrepancies and exceptions are reviewed before completion | Operations Manager | Per exception | Exception decision and reviewer rationale |
| POL-Payments-005-CTRL-03 | Confirm High and Critical risk matters receive required escalation | Senior Compliance Officer | Per escalated case | Enhanced review note and approval trail |
| POL-Payments-005-CTRL-04 | Confirm records are retained and retrievable for audit | Department Head | Quarterly | Sample review results and remediation tracker |

## 10 Related Documents

| Document ID | Title | Relationship |
| --- | --- | --- |
| [SOP-Payments-005](../sops/SOP-Payments-005_ACH_Payment_Processing_SOP.md) | ACH Payment Processing SOP | Mandatory policy cross-reference |
| [SOP-Payments-006](../sops/SOP-Payments-006_Payment_Exception_Handling_SOP.md) | Payment Exception Handling SOP | Mandatory policy cross-reference |
| [SOP-Payments-001](../sops/SOP-Payments-001_NEFT_Payment_Processing_SOP.md) | NEFT Payment Processing SOP | Mandatory policy cross-reference |
| [KOD-Payments-001](../kod/KOD-Payments-001_Domestic_Payment_Instruction_KOD.md) | Domestic Payment Instruction KOD | Mandatory policy cross-reference |
| [KOD-Payments-002](../kod/KOD-Payments-002_SWIFT_Payment_Instruction_KOD.md) | SWIFT Payment Instruction KOD | Mandatory policy cross-reference |
| [KOD-Payments-003](../kod/KOD-Payments-003_ACH_Mandate_Documentation_KOD.md) | ACH Mandate Documentation KOD | Mandatory policy cross-reference |
| [EXM-Payments-001](../exception_matrices/EXM-Payments-001_Domestic_Payment_Exception_Matrix.md) | Domestic Payment Exception Matrix | Mandatory policy cross-reference |
| [EXM-Payments-002](../exception_matrices/EXM-Payments-002_SWIFT_Payment_Exception_Matrix.md) | SWIFT Payment Exception Matrix | Mandatory policy cross-reference |
| [EXM-Payments-003](../exception_matrices/EXM-Payments-003_ACH_Payment_Exception_Matrix.md) | ACH Payment Exception Matrix | Mandatory policy cross-reference |

## 11 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for POL-Payments-005 ACH Processing Policy. | Chief Compliance Officer |
