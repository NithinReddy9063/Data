...
title: "Export Finance Control Policy"
...
related_documents:
  - document_id: "SOP-Trade Finance-003"
    path: "documents/sops/SOP-Trade_Finance-003_Export_Finance_Processing_SOP.md"
  - document_id: "SOP-Trade Finance-004"
    path: "documents/sops/SOP-Trade_Finance-004_Import_Finance_Processing_SOP.md"
  - document_id: "SOP-Trade Finance-005"
    path: "documents/sops/SOP-Trade_Finance-005_Documentary_Collection_Processing_SOP.md"
...
The policy supports the Operations Knowledge Assistant by providing approved decision logic, accountable roles, cross-reference points, and deployment-ready guidance for the document record POL-Trade Finance-003.
...
| --- | --- | --- | --- | --- |
| POL-Trade Finance-003-CTRL-01 | Confirm mandatory evidence is present and linked to the customer or case record | Operations Officer | Per request | Completed checklist and evidence record |
| POL-Trade Finance-003-CTRL-02 | Confirm discrepancies and exceptions are reviewed before completion | Operations Manager | Per exception | Exception decision and reviewer rationale |
| POL-Trade Finance-003-CTRL-03 | Confirm High and Critical risk matters receive required escalation | Senior Compliance Officer | Per escalated case | Enhanced review note and approval trail |
| POL-Trade Finance-003-CTRL-04 | Confirm records are retained and retrievable for audit | Department Head | Quarterly | Sample review results and remediation tracker |

## 10 Related Documents

| Document ID | Title | Relationship |
| --- | --- | --- |
| [SOP-Trade Finance-003](../sops/SOP-Trade_Finance-003_Export_Finance_Processing_SOP.md) | Export Finance Processing SOP | Mandatory policy cross-reference |
| [SOP-Trade Finance-004](../sops/SOP-Trade_Finance-004_Import_Finance_Processing_SOP.md) | Import Finance Processing SOP | Mandatory policy cross-reference |
| [SOP-Trade Finance-005](../sops/SOP-Trade_Finance-005_Documentary_Collection_Processing_SOP.md) | Documentary Collection Processing SOP | Mandatory policy cross-reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for POL-Trade Finance-003 Export Finance Control Policy. | Chief Compliance Officer |
