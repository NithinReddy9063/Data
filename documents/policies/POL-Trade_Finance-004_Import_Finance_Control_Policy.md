---
document_id: "POL-Trade Finance-004"
title: "Import Finance Control Policy"
...
related_documents:
  ...
  - document_id: "SOP-Trade Finance-006"
    path: "documents/sops/SOP-Trade_Finance-006_Trade_Transaction_Review_SOP.md"
  ...
  - document_id: "EXM-Trade Finance-002"
    path: "documents/exception_matrices/EXM-Trade_Finance-002_Bank_Guarantee_Exception_Matrix.md"
supersedes: null
synthetic: true
---
# Import Finance Control Policy
...
The policy supports the Operations Knowledge Assistant by providing approved decision logic, accountable roles, cross-reference points, and deployment-ready guidance for the document record POL-Trade Finance-004.
...
| --- | --- | --- | --- | --- |
| POL-Trade Finance-004-CTRL-01 | Confirm mandatory evidence is present and linked to the customer or case record | Operations Officer | Per request | Completed checklist and evidence record |
| POL-Trade Finance-004-CTRL-02 | Confirm discrepancies and exceptions are reviewed before completion | Operations Manager | Per exception | Exception decision and reviewer rationale |
| POL-Trade Finance-004-CTRL-03 | Confirm High and Critical risk matters receive required escalation | Senior Compliance Officer | Per escalated case | Enhanced review note and approval trail |
| POL-Trade Finance-004-CTRL-04 | Confirm records are retained and retrievable for audit | Department Head | Quarterly | Sample review results and remediation tracker |
...
| [SOP-Trade Finance-006](../sops/SOP-Trade_Finance-006_Trade_Transaction_Review_SOP.md) | Trade Transaction Review SOP | Mandatory policy cross-reference |
...
| [KOD-Trade Finance-002](../kod/KOD-Trade_Finance-002_Bank_Guarantee_Document_KOD.md) | Bank Guarantee Document KOD | Mandatory policy cross-reference |
...
| [EXM-Trade Finance-002](../exception_matrices/EXM-Trade_Finance-002_Bank_Guarantee_Exception_Matrix.md) | Bank Guarantee Exception Matrix | Mandatory policy cross-reference |

## 11 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for POL-Trade Finance-004 Import Finance Control Policy. | Chief Compliance Officer |
