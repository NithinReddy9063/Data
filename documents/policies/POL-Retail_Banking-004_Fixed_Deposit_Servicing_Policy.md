...
title: "Fixed Deposit Servicing Policy"
...
keywords:
  ...
  - "salary account"
  - "deposit servicing"
  - "fixed deposit servicing policy"
  - "POL-Retail"
  - "Banking-004"
  - "Fixed"
  - "Deposit"
...
related_documents:
  - document_id: "SOP-Retail Banking-004"
    path: "documents/sops/SOP-Retail_Banking-004_Fixed_Deposit_Service_Request_SOP.md"
...
The policy supports the Operations Knowledge Assistant by providing approved decision logic, accountable roles, cross-reference points, and deployment-ready guidance for the document record POL-Retail Banking-004.
...
| --- | --- | --- | --- | --- |
| POL-Retail Banking-004-CTRL-01 | Confirm mandatory evidence is present and linked to the customer or case record | Operations Officer | Per request | Completed checklist and evidence record |
| POL-Retail Banking-004-CTRL-02 | Confirm discrepancies and exceptions are reviewed before completion | Operations Manager | Per exception | Exception decision and reviewer rationale |
| POL-Retail Banking-004-CTRL-03 | Confirm High and Critical risk matters receive required escalation | Senior Compliance Officer | Per escalated case | Enhanced review note and approval trail |
| POL-Retail Banking-004-CTRL-04 | Confirm records are retained and retrievable for audit | Department Head | Quarterly | Sample review results and remediation tracker |

## 10 Related Documents

| Document ID | Title | Relationship |
| --- | --- | --- |
| [SOP-Retail Banking-004](../sops/SOP-Retail_Banking-004_Fixed_Deposit_Service_Request_SOP.md) | Fixed Deposit Service Request SOP | Mandatory policy cross-reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for POL-Retail Banking-004 Fixed Deposit Servicing Policy. | Chief Compliance Officer |
