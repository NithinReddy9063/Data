...
title: "AML Customer Screening Policy"
...
The policy supports the Operations Knowledge Assistant by providing approved decision logic, accountable roles, cross-reference points, and deployment-ready guidance for the document record POL-AML-001.
...
| --- | --- | --- | --- | --- |
| POL-AML-001-CTRL-01 | Confirm mandatory evidence is present and linked to the customer or case record | Operations Officer | Per request | Completed checklist and evidence record |
| POL-AML-001-CTRL-02 | Confirm discrepancies and exceptions are reviewed before completion | Operations Manager | Per exception | Exception decision and reviewer rationale |
| POL-AML-001-CTRL-03 | Confirm High and Critical risk matters receive required escalation | Senior Compliance Officer | Per escalated case | Enhanced review note and approval trail |
| POL-AML-001-CTRL-04 | Confirm records are retained and retrievable for audit | Department Head | Quarterly | Sample review results and remediation tracker |
...
| [SOP-AML-002](../sops/SOP-AML-002_Sanctions_Alert_Review_SOP.md) | Sanctions Alert Review SOP | Mandatory policy cross-reference |
| [SOP-AML-003](../sops/SOP-AML-003_Suspicious_Activity_Assessment_SOP.md) | Suspicious Activity Assessment SOP | Mandatory policy cross-reference |
...
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for POL-AML-001 AML Customer Screening Policy. | Chief Compliance Officer |
