...
title: "Corporate Customer Maintenance Policy"
...
keywords:
  ...
  - "escrow account"
  - "cash management"
  - "corporate customer maintenance policy"
  - "POL-Corporate"
  - "Banking-004"
  - "Corporate"
  - "Customer"
...
related_documents:
  - document_id: "SOP-Corporate Banking-004"
    path: "documents/sops/SOP-Corporate_Banking-004_Corporate_Customer_Maintenance_SOP.md"
  - document_id: "SOP-Corporate Banking-005"
    path: "documents/sops/SOP-Corporate_Banking-005_Corporate_Banking_Record_Maintenance_SOP.md"
  - document_id: "SOP-Corporate Banking-001"
    path: "documents/sops/SOP-Corporate_Banking-001_Business_Current_Account_Service_SOP.md"
  ...
  - document_id: "EXM-Corporate Banking-001"
    path: "documents/exception_matrices/EXM-Corporate_Banking-001_Business_Current_Account_Exception_Matrix.md"
  - document_id: "EXM-Corporate Banking-002"
    path: "documents/exception_matrices/EXM-Corporate_Banking-002_Escrow_Account_Exception_Matrix.md"
  - document_id: "EXM-Corporate Banking-003"
    path: "documents/exception_matrices/EXM-Corporate_Banking-003_Cash_Management_Exception_Matrix.md"
supersedes: null
synthetic: true
---
# Corporate Customer Maintenance Policy
...
This policy defines the mandatory governance, control, approval, and evidence requirements for corporate account servicing, escrow control, and cash management support within APEX Commercial Bank. It establishes a consistent enterprise standard for Corporate Banking activities so that customer decisions, operational actions, exception handling, and record keeping are performed in a controlled and auditable manner.

The policy supports the Operations Knowledge Assistant by providing approved decision logic, accountable roles, cross-reference points, and deployment-ready guidance for the document record POL-Corporate Banking-004.

## 2 Scope

This policy applies to the department COR - Corporate Banking, the business unit Corporate Banking, all applicable products and customer types defined in the Document Control metadata, and all ACB personnel performing or approving Corporate Banking activity.
...
1. ACB must perform corporate account servicing, escrow control, and cash management support in accordance with this policy and the related documents listed in the Related Documents section.
...
| --- | --- | --- | --- | --- |
| POL-Corporate Banking-004-CTRL-01 | Confirm mandatory evidence is present and linked to the customer or case record | Operations Officer | Per request | Completed checklist and evidence record |
| POL-Corporate Banking-004-CTRL-02 | Confirm discrepancies and exceptions are reviewed before completion | Operations Manager | Per exception | Exception decision and reviewer rationale |
| POL-Corporate Banking-004-CTRL-03 | Confirm High and Critical risk matters receive required escalation | Senior Compliance Officer | Per escalated case | Enhanced review note and approval trail |
| POL-Corporate Banking-004-CTRL-04 | Confirm records are retained and retrievable for audit | Department Head | Quarterly | Sample review results and remediation tracker |

## 10 Related Documents

| Document ID | Title | Relationship |
| --- | --- | --- |
| [SOP-Corporate Banking-004](../sops/SOP-Corporate_Banking-004_Corporate_Customer_Maintenance_SOP.md) | Corporate Customer Maintenance SOP | Mandatory policy cross-reference |
| [SOP-Corporate Banking-005](../sops/SOP-Corporate_Banking-005_Corporate_Banking_Record_Maintenance_SOP.md) | Corporate Banking Record Maintenance SOP | Mandatory policy cross-reference |
| [SOP-Corporate Banking-001](../sops/SOP-Corporate_Banking-001_Business_Current_Account_Service_SOP.md) | Business Current Account Service SOP | Mandatory policy cross-reference |
| [KOD-Corporate Banking-001](../kod/KOD-Corporate_Banking-001_Business_Current_Account_Documents_KOD.md) | Business Current Account Documents KOD | Mandatory policy cross-reference |
| [KOD-Corporate Banking-002](../kod/KOD-Corporate_Banking-002_Escrow_Account_Documents_KOD.md) | Escrow Account Documents KOD | Mandatory policy cross-reference |
| [KOD-Corporate Banking-003](../kod/KOD-Corporate_Banking-003_Cash_Management_Documents_KOD.md) | Cash Management Documents KOD | Mandatory policy cross-reference |
| [EXM-Corporate Banking-001](../exception_matrices/EXM-Corporate_Banking-001_Business_Current_Account_Exception_Matrix.md) | Business Current Account Exception Matrix | Mandatory policy cross-reference |
| [EXM-Corporate Banking-002](../exception_matrices/EXM-Corporate_Banking-002_Escrow_Account_Exception_Matrix.md) | Escrow Account Exception Matrix | Mandatory policy cross-reference |
| [EXM-Corporate Banking-003](../exception_matrices/EXM-Corporate_Banking-003_Cash_Management_Exception_Matrix.md) | Cash Management Exception Matrix | Mandatory policy cross-reference |

## 11 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for POL-Corporate Banking-004 Corporate Customer Maintenance Policy. | Chief Compliance Officer |
