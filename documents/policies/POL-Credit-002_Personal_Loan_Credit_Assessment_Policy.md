...
title: "Personal Loan Credit Assessment Policy"
...
keywords:
  ...
  - "working capital"
  - "overdraft"
  - "personal loan credit assessment policy"
  - "POL-Credit-002"
  - "Personal"
  - "Loan"
  - "Assessment"
related_documents:
  - document_id: "SOP-Credit-002"
    path: "documents/sops/SOP-Credit-002_Personal_Loan_Credit_Assessment_SOP.md"
  - document_id: "SOP-Credit-003"
    path: "documents/sops/SOP-Credit-003_Business_Loan_Credit_Assessment_SOP.md"
  - document_id: "SOP-Credit-004"
    path: "documents/sops/SOP-Credit-004_Working_Capital_Review_SOP.md"
  ...
  - document_id: "KOD-Credit-004"
    path: "documents/kod/KOD-Credit-004_Overdraft_Document_KOD.md"
  - document_id: "EXM-Credit-002"
    path: "documents/exception_matrices/EXM-Credit-002_Business_Loan_Exception_Matrix.md"
  - document_id: "EXM-Credit-003"
    path: "documents/exception_matrices/EXM-Credit-003_Working_Capital_Exception_Matrix.md"
  - document_id: "EXM-Credit-004"
    path: "documents/exception_matrices/EXM-Credit-004_Overdraft_Exception_Matrix.md"
supersedes: null
synthetic: true
---
# Personal Loan Credit Assessment Policy
...
This policy defines the mandatory governance, control, approval, and evidence requirements for credit assessment, facility review, and lending evidence control within APEX Commercial Bank. It establishes a consistent enterprise standard for Credit activities so that customer decisions, operational actions, exception handling, and record keeping are performed in a controlled and auditable manner.

The policy supports the Operations Knowledge Assistant by providing approved decision logic, accountable roles, cross-reference points, and deployment-ready guidance for the document record POL-Credit-002.

## 2 Scope

This policy applies to the department CRD - Credit Risk, the business unit Risk, all applicable products and customer types defined in the Document Control metadata, and all ACB personnel performing or approving Credit activity.
...
1. ACB must perform credit assessment, facility review, and lending evidence control in accordance with this policy and the related documents listed in the Related Documents section.
...
| --- | --- | --- | --- |
| Standard review request received | High Risk Review - 5 Business Days | Operations Officer records decision or blocker | SLA cannot be met because evidence or approval is incomplete |
...
| --- | --- | --- | --- | --- |
| POL-Credit-002-CTRL-01 | Confirm mandatory evidence is present and linked to the customer or case record | Operations Officer | Per request | Completed checklist and evidence record |
| POL-Credit-002-CTRL-02 | Confirm discrepancies and exceptions are reviewed before completion | Operations Manager | Per exception | Exception decision and reviewer rationale |
| POL-Credit-002-CTRL-03 | Confirm High and Critical risk matters receive required escalation | Senior Compliance Officer | Per escalated case | Enhanced review note and approval trail |
| POL-Credit-002-CTRL-04 | Confirm records are retained and retrievable for audit | Department Head | Quarterly | Sample review results and remediation tracker |

## 10 Related Documents

| Document ID | Title | Relationship |
| --- | --- | --- |
| [SOP-Credit-002](../sops/SOP-Credit-002_Personal_Loan_Credit_Assessment_SOP.md) | Personal Loan Credit Assessment SOP | Mandatory policy cross-reference |
| [SOP-Credit-003](../sops/SOP-Credit-003_Business_Loan_Credit_Assessment_SOP.md) | Business Loan Credit Assessment SOP | Mandatory policy cross-reference |
| [SOP-Credit-004](../sops/SOP-Credit-004_Working_Capital_Review_SOP.md) | Working Capital Review SOP | Mandatory policy cross-reference |
| [KOD-Credit-002](../kod/KOD-Credit-002_Business_Loan_Document_KOD.md) | Business Loan Document KOD | Mandatory policy cross-reference |
| [KOD-Credit-003](../kod/KOD-Credit-003_Working_Capital_Document_KOD.md) | Working Capital Document KOD | Mandatory policy cross-reference |
| [KOD-Credit-004](../kod/KOD-Credit-004_Overdraft_Document_KOD.md) | Overdraft Document KOD | Mandatory policy cross-reference |
| [EXM-Credit-002](../exception_matrices/EXM-Credit-002_Business_Loan_Exception_Matrix.md) | Business Loan Exception Matrix | Mandatory policy cross-reference |
| [EXM-Credit-003](../exception_matrices/EXM-Credit-003_Working_Capital_Exception_Matrix.md) | Working Capital Exception Matrix | Mandatory policy cross-reference |
| [EXM-Credit-004](../exception_matrices/EXM-Credit-004_Overdraft_Exception_Matrix.md) | Overdraft Exception Matrix | Mandatory policy cross-reference |

## 11 Revision History

| Version | Date | Author | Summary of Changes | Approved By |
| --- | --- | --- | --- | --- |
| 1.0 | 2026-07-01 | Department Head | Initial approved deployment version for POL-Credit-002 Personal Loan Credit Assessment Policy. | Chief Compliance Officer |
